...
* [Engramory](https://github.com/tinqiao-oss/engramory) ⭐ 178 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Curated, file-based long-term memory for DSH agents — plain markdown notes in one store shared across hosts, with the index size cap enforced as a monotonic `ctx.tools.guard()` refusal rather than a reminder. Install: `dsh plugin --profile <name> add dsh-engramory`.
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 53 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-25 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
* [MCP Migration Check](https://github.com/AlpayC/mcp-migration-check) ⭐ 5 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 - Deterministic MCP 2026-07-28 migration checker with an agent skill, CLI, GitHub Action, and hosted web probe powered by one rule engine.
...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 504 | 🐛 37 | 🌐 Python | 📅 2026-08-30** — recommended local preflight
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,252 | 🐛 8 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,189 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,020 | 🐛 12 | 🌐 Shell | 📅 2026-08-30 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,237 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,571 | 🐛 54 | 🌐 Dockerfile | 📅 2026-08-30 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,432 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-30 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,154 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 501 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-30 - Spend less context and keep the conclusions across 16 coding clients including Claude Code, Codex, Gemini CLI, Cursor, and Copilot — diff-only re-reads, paths-only search, out-of-context stashing, and a local ledger that measures each tool's actual return.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 465 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-30 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 431 | 🐛 1 | 🌐 Shell | 📅 2026-08-28 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 279 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
...
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 182 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 129 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-30 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [2718lab DevKit](https://github.com/2718labs/2718lab-devkit) ⭐ 92 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - Codex-first local MCP server and skill bundle for deterministic project intelligence, durable workflow orchestration, and reusable engineering tools.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 37 | 🐛 208 | 🌐 Python | 📅 2026-08-30 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Designer Skill](https://github.com/Pythoughts-labs/designer-skill) ⭐ 29 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-26 - Plug-and-play MCP that gives your agent UI superpowers. One install: design skill + MCP server, zero config.
...
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 27 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-30 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 24 | 🐛 4 | 🌐 Shell | 📅 2026-08-30 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 21 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 17 | 🐛 9 | 🌐 Rust | 📅 2026-08-30 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
* [SOTA Engineering Skills](https://github.com/martinholovsky/SOTA-skills) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Router-mapped library of 40 domain and language skills with BUILD and AUDIT modes, loading only the rules a task needs and ending every rules file in an audit checklist.
...
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-30 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
...
* [trigger-tree](https://github.com/Hedde/trigger_tree) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Local documentation telemetry for Claude Code and Codex: see which docs your agent actually reads, gate discoverability in CI, and measure instruction adherence.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-30 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 2 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-28 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 9 | 🌐 Python | 📅 2026-08-30 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
* [GCF Proxy](https://github.com/blackwell-systems/gcf-codex-plugin) ⭐ 1 | 🐛 2 | 📅 2026-08-29 - Save 71% on MCP tool call tokens by wrapping any server with GCF encoding, with session stats hook and setup skill.
...
* [Agent Deck](https://github.com/not-so-fat/agent-deck) ⭐ 0 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-30 - One MCP for context management: bind self-improving playbooks, MCP tools, and API keys to the session.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 14,373 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-30 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,087 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,045 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 777 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 705 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 619 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 231 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-06 - Publish short-form videos to TikTok, Instagram Reels, YouTube Shorts, X, and Facebook from Codex with the Taisly MCP server and bundled social media posting skill.
...
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 196 | 🐛 1 | 🌐 Go | 📅 2026-08-30 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
...
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 191 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-27 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 180 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 148 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-28 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 121 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 85 | 🐛 4 | 🌐 Go | 📅 2026-08-30 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 50 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Talivia Agent Kit](https://github.com/talivia-group/agent) ⭐ 36 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-02 - Install and verify revenue-first website analytics from Codex, connect payment attribution, and identify which traffic sources and customer journeys become revenue.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 199 | 🐛 259 | 🌐 Python | 📅 2026-08-30
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,250 | 🐛 0 | 🌐 Rust | 📅 2026-08-28
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,155 | 🐛 1,240 | 🌐 TypeScript | 📅 2026-08-30
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 740 | 🐛 80 | 🌐 Go | 📅 2026-08-30 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 204,453 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 740 | 🐛 80 | 🌐 Go | 📅 2026-08-30 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 504 | 🐛 37 | 🌐 Python | 📅 2026-08-30 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 13,688 | 🐛 305 | 🌐 Python | 📅 2026-08-30 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,155 | 🐛 1,240 | 🌐 TypeScript | 📅 2026-08-30 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 859 | 🐛 40 | 🌐 Python | 📅 2026-08-28 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 199 | 🐛 259 | 🌐 Python | 📅 2026-08-30 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 504 | 🐛 37 | 🌐 Python | 📅 2026-08-30 to produce a trust score and security analysis.
