...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 446 | 🐛 31 | 🌐 Python | 📅 2026-08-18** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 3 | 🐛 1 | 📅 2026-08-18** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,609 | 🐛 37 | 🌐 Python | 📅 2026-08-17 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,086 | 🐛 4 | 🌐 Shell | 📅 2026-08-15 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 3,982 | 🐛 3 | 🌐 Shell | 📅 2026-08-17 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,379 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-14 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,313 | 🐛 3 | 🌐 Python | 📅 2026-08-14 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,053 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 749 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-16 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
* [Boss](https://github.com/echoVic/boss-skill) ⭐ 547 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-16 - BMAD pipeline plugin that orchestrates a full requirements-to-deploy workflow across nine specialist agents with an auditable runtime DAG and quality gates, for Claude Code, Codex, OpenClaw, and Antigravity.
...
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 454 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-16 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 425 | 🐛 2 | 🌐 Go | 📅 2026-08-18 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
* [Reviewable HTML Workbench](https://github.com/u-ichi/reviewable-html-workbench) ⭐ 284 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - Generate reviewable HTML documents, serve previews, collect inline review comments, and feed review outcomes back into agent workflows.
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 225 | 🐛 21 | 🌐 Python | 📅 2026-08-18 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 172 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-17 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 108 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-18 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
* [Sealos](https://github.com/labring/sealos-skills) ⭐ 70 | 🐛 6 | 🌐 Python | 📅 2026-08-14 - Deploy apps to Sealos Cloud from Codex with readiness checks, Dockerfile generation, Compose conversion, image builds, and rollout updates.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 46 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 35 | 🐛 226 | 🌐 Python | 📅 2026-08-17 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Designer Skill](https://github.com/Pythoughts-labs/designer-skill) ⭐ 27 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-18 - Plug-and-play MCP that gives your agent UI superpowers. One install: design skill + MCP server, zero config.
* [Open Dynamic Workflows](https://github.com/Suraj1235/open-dynamic-workflows) ⭐ 27 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-09 - Local-first MIT dynamic multi-agent workflows for Codex, OpenCode, Antigravity, Cursor, and VS Code with a daemon, MCP bridge, Codex skills, OpenCode plugin, and bring-your-own-model support.
* [Hera Agent Unity](https://github.com/NotNull92/hera-agent-unity) ⭐ 26 | 🐛 0 | 🌐 C# | 📅 2026-08-18 - Controls and verifies a live Unity Editor through a low-token CLI, with scene, asset, Inspector, Play Mode, test, screenshot, and runtime C# workflows for Codex and other coding agents.
...
* [AgentPack](https://github.com/vishal2612200/agentpack) ⭐ 23 | 🐛 15 | 🌐 Python | 📅 2026-08-18 - Ranks repo context for Codex with likely files, skill recommendations, agent rules, commands, warnings, and compact task-focused packs before editing.
...
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 19 | 🐛 5 | 🌐 Shell | 📅 2026-08-16 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [Alcove](https://github.com/epicsagas/alcove) ⭐ 15 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - Local-first MCP server for private project docs with hybrid BM25+vector search, tree-sitter code indexing, and automated linting for team-wide documentation standards.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-08-18 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [ArmorCodex](https://github.com/armoriq/armorCodex) ⭐ 5 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-11 - Intent-based security for Codex with MCP plan registration, policy gating, CSRG cryptographic proofs, and audit logging on `bash` and `apply_patch`.
...
* [VillageSQL Skills](https://github.com/villagesql/villagesql-skills) ⭐ 5 | 🐛 0 | 📅 2026-08-13 - Skills for VillageSQL including building extensions from scratch and porting PostgreSQL extensions to VillageSQL.
...
* [HOL Guard Plugin](https://github.com/hashgraph-online/hol-guard-plugin) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-18 - AI antivirus workflow for Codex, Claude Code, Cursor, Gemini, OpenCode, MCP servers, skills, and plugin release checks with local approvals and receipts.
* [Simple Man](https://github.com/Maksim-Burtsev/simple-man) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - High-compression communication mode for Codex agents that removes filler while preserving search, validation, and implementation effort.
...
* [Codex How To](https://github.com/Phelan164/codex-howto) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - Engineering-first Codex curriculum and plugin with 9 skills, measured token-efficiency experiments, bounded orchestration, testing, review, and living knowledge maintenance.
* [Codex Process Jobs](https://github.com/joelfarthing/codex-process-jobs) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-09 - Run long local builds, tests, benchmarks, and inference jobs as durable detached processes with tracked status, bounded results, and completion delivery across Codex surfaces.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 2 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-18 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
...
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 11,771 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-18 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 979 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 745 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 626 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 562 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 203 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
* [Codex Usage Tracker](https://github.com/douglasmonsky/codex-usage-tracker) ⭐ 194 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - Track aggregate Codex token usage from local session logs with MCP tools for summaries, session detail, CSV export, and dashboard generation.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 190 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 183 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 173 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-11 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 96 | 🐛 3 | 🌐 Python | 📅 2026-06-29 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2026-08-18 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
* [Jenkins CLI](https://github.com/avivsinai/jenkins-cli) ⭐ 81 | 🐛 6 | 🌐 Go | 📅 2026-08-17 - GitHub CLI-style interface for Jenkins controllers with jobs, pipelines, runs, logs, artifacts, credentials, and nodes.
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 77 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-18 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 15 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [Val Town](https://github.com/val-town/plugins) ⭐ 10 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-17 - Build and deploy serverless TypeScript on Val Town from Codex — hosted MCP server plus skills for HTTP vals, cron, SQLite, email, OAuth, and React UI.
...
* [Unified AI System](https://github.com/happy520ai/unified-ai-system) ⭐ 5 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-16 - Self-hosted AI gateway for Codex with provider-free prompt enhancement, nine governed MCP tools, and a credential-free Docker path.
...
* [Read Image](https://github.com/ZXY1240/read-image) ⭐ 3 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - Read local images, videos, web pages, and Windows screenshots through Doubao, GLM, or Qwen-compatible vision APIs.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 154 | 🐛 125 | 🌐 Python | 📅 2026-08-17
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 25,599 | 🐛 0 | 🌐 Rust | 📅 2026-08-17
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 6,882 | 🐛 1,124 | 🌐 TypeScript | 📅 2026-08-18
before submitting.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 157,947 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 446 | 🐛 31 | 🌐 Python | 📅 2026-08-18 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 8,415 | 🐛 170 | 🌐 Python | 📅 2026-08-18 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 6,882 | 🐛 1,124 | 🌐 TypeScript | 📅 2026-08-18 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 821 | 🐛 28 | 🌐 Python | 📅 2026-08-18 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 154 | 🐛 125 | 🌐 Python | 📅 2026-08-17 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 446 | 🐛 31 | 🌐 Python | 📅 2026-08-18 to produce a trust score and security analysis.
