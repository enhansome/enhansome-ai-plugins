...
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 36 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-25 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
* [MCP Migration Check](https://github.com/AlpayC/mcp-migration-check) ⭐ 5 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-27 - Deterministic MCP 2026-07-28 migration checker with an agent skill, CLI, GitHub Action, and hosted web probe powered by one rule engine.
...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 490 | 🐛 36 | 🌐 Python | 📅 2026-08-27** — recommended local preflight
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,093 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,174 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,012 | 🐛 0 | 🌐 Shell | 📅 2026-08-27 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,223 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,570 | 🐛 44 | 🌐 Dockerfile | 📅 2026-08-27 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,422 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-24 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,136 | 🐛 1 | 🌐 Python | 📅 2026-08-27 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 773 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-26 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 499 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 - Spend less context and keep the conclusions across 16 coding clients including Claude Code, Codex, Gemini CLI, Cursor, and Copilot — diff-only re-reads, paths-only search, out-of-context stashing, and a local ledger that measures each tool's actual return.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 463 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 429 | 🐛 2 | 🌐 Shell | 📅 2026-08-27 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 133 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-27 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [2718lab DevKit](https://github.com/2718labs/2718lab-devkit) ⭐ 58 | 🐛 2 | 🌐 Python | 📅 2026-08-27 - Codex-first local MCP server and skill bundle for deterministic project intelligence, durable workflow orchestration, and reusable engineering tools.
...
* [Honcho](https://github.com/plastic-labs/codex-honcho) ⭐ 50 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-16 - Persistent cross-session memory for Codex powered by Honcho — lifecycle hooks capture each session and inject relevant context back at session start, so Codex remembers your preferences, projects, and decisions across restarts.
...
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
...
* [SOTA Engineering Skills](https://github.com/martinholovsky/SOTA-skills) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Router-mapped library of 40 domain and language skills with BUILD and AUDIT modes, loading only the rules a task needs and ending every rules file in an audit checklist.
...
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
...
* [Agentic Ship](https://github.com/moasq/agentic-ship) ⭐ 10 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-23 - Cross-host product-development toolkit for Claude Code, Codex, Cursor, Hermes, and OpenClaw with shared rules, specialist roles, service connections, and machine-checked UI, backend, security, and launch gates.
...
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-08-27 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 13,981 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-27 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
...
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,032 | 🐛 4 | 🌐 Python | 📅 2026-08-20 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
...
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 701 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 606 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 219 | 🐛 0 | 🌐 Shell | 📅 2026-08-27 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
* [Telnyx](https://github.com/team-telnyx/ai) ⭐ 212 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 - Telnyx toolkit for AI agents bundling Claude Code, Cursor, Gemini CLI, and OpenCode plugins, an agent toolkit for OpenAI/LangChain/CrewAI/Vercel AI SDK, a hosted MCP server, and a one-command CLI for messaging, voice, numbers, and account management.
...
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 189 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-27 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 180 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 145 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-27 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 119 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-27 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [agentmailkit](https://github.com/ariaxhan/agentmailkit) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - MCP server for scheduled LLM-written email digests from RSS, web and local sources: tools list\_jobs/run\_job/preview\_job/list\_plugins, local-first, run\_job dry-run by default; `pip install "agentmailkit[mcp]"` then `agentmailkit mcp`.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 191 | 🐛 204 | 🌐 Python | 📅 2026-08-27
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,143 | 🐛 0 | 🌐 Rust | 📅 2026-08-27
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,118 | 🐛 1,200 | 🌐 TypeScript | 📅 2026-08-27
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 731 | 🐛 151 | 🌐 Go | 📅 2026-08-27 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 200,113 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 731 | 🐛 151 | 🌐 Go | 📅 2026-08-27 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 490 | 🐛 36 | 🌐 Python | 📅 2026-08-27 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 13,192 | 🐛 431 | 🌐 Python | 📅 2026-08-27 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,118 | 🐛 1,200 | 🌐 TypeScript | 📅 2026-08-27 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 854 | 🐛 39 | 🌐 Python | 📅 2026-08-27 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 191 | 🐛 204 | 🌐 Python | 📅 2026-08-27 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 490 | 🐛 36 | 🌐 Python | 📅 2026-08-27 to produce a trust score and security analysis.
