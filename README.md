...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 546 | 🐛 42 | 🌐 Python | 📅 2026-09-04** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-04** — recommended for security, optional for listing
...
* [Planning with Files](https://github.com/OthmanAdi/planning-with-files) ⭐ 26,628 | 🐛 8 | 🌐 Shell | 📅 2026-09-02 - Persistent file-based planning for Claude Code, Codex, and other AI coding agents, preserving task plans, findings, and progress across context loss, crashes, and compaction.
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,527 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Browser Harness](https://github.com/browser-use/browser-harness) ⭐ 17,377 | 🐛 324 | 🌐 Python | 📅 2026-09-04 - MCP server and agent skill that connect an AI agent to a real browser through one editable CDP WebSocket.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,218 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,043 | 🐛 16 | 🌐 Shell | 📅 2026-09-04 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
...
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,577 | 🐛 40 | 🌐 Dockerfile | 📅 2026-09-04 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Better Harness](https://github.com/QoderAI/better-harness) ⭐ 2,163 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-04 - Evidence-backed workflow analysis for coding agents that turns project and session signals into prioritized, verifiable improvements across supported hosts.
...
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,447 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,167 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
...
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 471 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
...
* [MisakaNet](https://github.com/Ikalus1988/MisakaNet) ⭐ 433 | 🐛 68 | 🌐 Python | 📅 2026-09-04 - Git-backed failure-memory for AI coding agents with 290 indexed lessons, MCP server with 5 tools (search, get\_lesson, submit\_usage, submit\_intake, usage\_status), and DeepSeekHarness adapter.
* [AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 327 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-03 - Local bidirectional bridge that keeps Claude Code and Codex live as peers in one session, with mid-turn injection and quota-window handoff.
...
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 288 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
* [OpenCode Orchestrator](https://github.com/agnusdei1207/opencode-orchestrator) ⭐ 235 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Multi-agent mission control for OpenCode with Commander, Planner, Worker, and Reviewer workflows.
* [Knowledge Manager](https://github.com/treylom/knowledge-manager) ⭐ 230 | 🐛 1 | 🌐 Python | 📅 2026-09-04 - Extracts and organizes content from web pages, files, Notion, and images into an Obsidian knowledge vault with GraphRAG-backed search, exporting to Notion, Markdown, and PDF.
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 188 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-31 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
...
* [agent-talk](https://github.com/xhluca/agent-talk) ⭐ 181 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - Skills-based plugin built on the retalk CLI that gives coding agents end-to-end encrypted messaging with other agents, including agents run by other people, across Claude Code, Codex, Antigravity, pi, opencode, and GitHub Copilot CLI.
* [claude-remember](https://github.com/Digital-Process-Tools/claude-remember) ⭐ 164 | 🐛 5 | 🌐 Python | 📅 2026-09-04 - Persistent memory for Claude Code with identity, context, and continuity carried across sessions.
...
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 129 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-04 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 108 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
* [trace-mcp](https://github.com/nikolai-vysotskyi/trace-mcp) ⭐ 103 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-04 - Precomputed code-intelligence graph served over MCP — symbol search, call graphs, change impact, and test mapping as structured answers instead of whole-file reads.
* [Coordinate Agents](https://github.com/hogancv/coordinate-agents) ⭐ 102 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-03 - Plugin-first multi-agent coordination tool with a local-first, recoverable Agent Bus and human-gated planning, implementation, review, and release workflows.
* [2718lab DevKit](https://github.com/2718labs/2718lab-devkit) ⭐ 101 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - Codex-first local MCP server and skill bundle for deterministic project intelligence, durable workflow orchestration, and reusable engineering tools.
...
* [taskflow](https://github.com/heggria/taskflow) ⭐ 68 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-02 - Declarative, verifiable DAG orchestration for Grok Build subagents — fan-out, gates, loops, tournaments, approvals, and resumable runs via MCP tools, with intermediate transcripts kept out of context.
...
* [skillsaw](https://github.com/stbenjam/skillsaw) ⭐ 62 | 🐛 7 | 🌐 Python | 📅 2026-09-04 - A configurable linter for agent skills, plugins, and AI coding assistant context.
* [pstack for Codex](https://github.com/Aqua-123/pstack-for-codex) ⭐ 61 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Codex-native engineering workflows derived from pstack, with 45 explicit skills and 23 Poteto Mode playbooks.
* [MCP Video Analyzer](https://github.com/guimatheus92/mcp-video-analyzer) ⭐ 56 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-03 - Gives agents video input: transcript, key frames, OCR text, metadata, and an annotated timeline from Loom, YouTube, Instagram, TikTok, direct URLs, or a local file, over MCP, a one-shot CLI, or the /video skill.
* [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) ⭐ 54 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-28 - Whale-girl desktop pet for the DSH Web UI with pat-to-raise growth, work-state poses, 494 dialogue lines, 30 achievements and a built-in settings panel; local-first, zero telemetry.
* [mcp-local-memory](https://github.com/Beledarian/mcp-local-memory) ⭐ 54 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-26 - A lightweight, powerful local memory server for AI agents supporting text, entities, relations, and time-based recall.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 49 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
* [Dely](https://github.com/hieuphung97/dely) ⭐ 46 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - Multi-harness control protocol that turns requests into approved design contracts, orchestrating isolated worker sessions for sequential implementation and independent code reviews under Orca supervision for Claude Code, Codex, Cursor, Antigravity, and other AI coding agents.
* [Rootly MCP Server](https://github.com/rootlyhq/rootly-mcp-server) ⭐ 45 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Manage and resolve production incidents from MCP-compatible AI assistants through dynamically generated, access-controlled Rootly API tools.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 39 | 🐛 215 | 🌐 Python | 📅 2026-09-03 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
* [iris-agentic-dev](https://github.com/intersystems-community/iris-agentic-dev) ⭐ 37 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - MCP server giving AI assistants live access to InterSystems IRIS — execute ObjectScript, query globals, inspect productions, run tests, search code, and manage skills.
...
* [Knowledge Loom](https://github.com/magickaichen/knowledge-loom) ⭐ 36 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-03 - Agent-neutral skills for initializing, auditing, using, and maintaining governed local Markdown knowledge vaults across Agent Skills-compatible runtimes.
...
* [Labtasker](https://github.com/luocfprime/labtasker) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - Queue and run independent ML inference, evaluation, and experiment tasks across long-lived Python or command workers with a Claude Code plugin and cross-agent skill.
* [Velith](https://github.com/epicsagas/Velith) ⭐ 33 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - AI-native publishing system with a 6-phase pipeline from ideation to EPUB/PDF across 8 genres.
* [Designer Skill](https://github.com/Pythoughts-labs/designer-skill) ⭐ 30 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - Plug-and-play MCP that gives your agent UI superpowers. One install: design skill + MCP server, zero config.
...
* [BioNexus](https://github.com/HERRY423/BioNexus) ⭐ 28 | 🐛 12 | 🌐 Python | 📅 2026-09-04 - Warrant-first scientific reliability layer for AI bioinformatics that audits analytical assumptions, calibrates evidence strength, caps unsupported claims, and verifies execution provenance.
...
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 28 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 25 | 🐛 3 | 🌐 Shell | 📅 2026-09-03 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [Supergraph](https://github.com/datit309/supergraph) ⭐ 22 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 - Engineering workflow system for AI coding agents that enforces planning, TDD, verification, review, and architecture-aware decisions with local codebase graph intelligence across Claude Code, Codex CLI, Antigravity, and OpenCode,..
* [go-ultimate](https://github.com/Djarvur/go-ultimate) ⭐ 21 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - Opinionated Go skill that routes any Go task (CLI, library, backend service, MCP server, AI agent) to the right architecture, conventions, and review checklist across Claude Code, Codex, Cursor, Grok Build, Copilot CLI, and OpenCode.
...
* [mcp-zuul](https://github.com/imatza-rh/mcp-zuul) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - MCP server for Zuul CI with 48 tools for build analysis, failure diagnosis, log search, flaky job detection, pipeline status, and live console streaming.
...
* [Rel.AI MCP](https://github.com/Kyne0328/rel-ai-mcp) ⭐ 19 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Brings Codex-style coding workflows to ChatGPT Web, connecting it to local development workspaces through MCP while using ChatGPT Web quota instead of Codex quota.
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 17 | 🐛 8 | 🌐 Rust | 📅 2026-09-04 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
* [UIZZE](https://github.com/uizze/uizze) ⭐ 17 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [claude-supertool](https://github.com/Digital-Process-Tools/claude-supertool) ⭐ 16 | 🐛 93 | 🌐 Python | 📅 2026-09-04 - Batches file, git and tracker operations into one round-trip, collapsing many reads, greps and globs into a single call for fewer output tokens and less wall time.
...
* [Alcove](https://github.com/epicsagas/alcove) ⭐ 15 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - Local-first MCP server for private project docs with hybrid BM25+vector search, tree-sitter code indexing, and automated linting for team-wide documentation standards.
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-04 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
...
* [TermaGITchi](https://github.com/TevvvB/termagitchi) ⭐ 14 | 🐛 3 | 🌐 Go | 📅 2026-09-03 - Stable per-worktree identity for parallel Claude Code, Codex, and tmux sessions; mood reads repository hygiene, not what the agent is doing.
...
* [Claude Watchdog](https://github.com/Temikus/claude-watchdog) ⭐ 12 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - Stop hook that runs a critical post-mortem on every Claude Code session, cross-checking what was asked against the actual git diff for missed goals, wasted detours, and unverified claims.
* [Kernel](https://github.com/ariaxhan/kernel-claude) ⭐ 12 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-04 - Claude Code plugin marketplace and Codex plugin: hooks that block destructive commands, spawn guards on subagent contracts, agentdb memory with recall-before-act, blind verifiers, deterministic review; install with `/plugin marketplace add ariaxhan/kernel-claude`.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 11 | 🐛 13 | 🌐 Python | 📅 2026-09-04 - Interactive cross-filter dashboards for large datasets with a Claude Code skill for agent-driven data exploration.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-09-04 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-03 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [Windrunner](https://github.com/shzlw/windrunner) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04 - Self-hosted project workspace with Spring AI, MCP, CLI, and multi-provider AI integrations.
...
* [Codex How To](https://github.com/Phelan164/codex-howto) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-09-04 - Engineering-first Codex curriculum and plugin with 9 skills, measured token-efficiency experiments, bounded orchestration, testing, review, and living knowledge maintenance.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 3 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-04 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
* [River Review](https://github.com/s977043/river-review) ⭐ 3 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-04 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [claude-jit-context](https://github.com/Digital-Process-Tools/claude-jit-context) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-04 - Project knowledge that loads only when it is needed, matched against the prompt, the file being touched, or the tool being run instead of sitting in context all session.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Mermail Skills](https://github.com/Nudgen-Marketing/mermail-skills) ⭐ 1 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-03 - Official Mermail Agent Skills and Codex plugin that connect AI assistants to hosted Mermail MCP for inbox, scheduling, GTM, support, and x402 wallet workflows.
...
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 15,027 | 🐛 157 | 🌐 JavaScript | 📅 2026-09-04 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,099 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,092 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-04 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 847 | 🐛 4 | 🌐 Python | 📅 2026-09-03 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 791 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 729 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
...
* [Telnyx](https://github.com/team-telnyx/ai) ⭐ 212 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-04 - Telnyx toolkit for AI agents bundling Claude Code, Cursor, Gemini CLI, and OpenCode plugins, an agent toolkit for OpenAI/LangChain/CrewAI/Vercel AI SDK, a hosted MCP server, and a one-command CLI for messaging, voice, numbers, and account management.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 200 | 🐛 6 | 🌐 Go | 📅 2026-09-01 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
...
* [Codex Usage Tracker](https://github.com/douglasmonsky/codex-usage-tracker) ⭐ 192 | 🐛 10 | 🌐 Python | 📅 2026-08-20 - Track aggregate Codex token usage from local session logs with MCP tools for summaries, session detail, CSV export, and dashboard generation.
...
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 150 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-04 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
...
* [Zero Slop](https://github.com/manavmishra/ZeroSlop) ⭐ 105 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Say no to AI slop: a human-in-the-loop learning agentic workflow skill that scores text 0-100 for AI slop and rewrites it tastefully, with a standard-library Python scorer that has zero dependencies and runs offline.
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 87 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-27 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 85 | 🐛 0 | 🌐 Go | 📅 2026-09-04 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
* [Jenkins CLI](https://github.com/avivsinai/jenkins-cli) ⭐ 83 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - GitHub CLI-style interface for Jenkins controllers with jobs, pipelines, runs, logs, artifacts, credentials, and nodes.
* [Cortex](https://github.com/cdeust/Cortex) ⭐ 71 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - Persistent thermodynamic memory and cognitive-profiling MCP server for Claude Code, Codex, and Gemini CLI — heat/decay dynamics, predictive-coding write gates, knowledge graph, and intent-aware recall across sessions.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 54 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [immich-photo-manager](https://github.com/drolosoft/immich-photo-manager) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - MCP server and Claude Code plugin for self-hosted Immich photo libraries: CLIP and OCR search, geographic album curation, duplicate detection, people and faces, metadata repair, video frames and PDF photobooks, 94 tools and 13 skills tested live on Immich 2.x and 3.x, also via uvx or Docker.
...
* [Scholar Feed](https://github.com/YGao2005/scholar-feed-mcp) ⭐ 10 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-04 - MCP server over 600k+ CS/AI/ML papers: rank by citations or forecast rising impact, trace 23.2M citation edges, and pull full text and BibTeX; `npx -y scholar-feed-mcp`.
...
* [Unified AI System](https://github.com/happy520ai/unified-ai-system) ⭐ 6 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-04 - Self-hosted AI gateway for Codex with provider-free prompt enhancement, nine governed MCP tools, and a credential-free Docker path.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 212 | 🐛 354 | 🌐 Python | 📅 2026-09-04
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,464 | 🐛 0 | 🌐 Rust | 📅 2026-09-01
before submitting.

* [Grok Imagine Cinematic Studio](https://github.com/FineComputer14451/Grok-Imagine-Cinematic-Studio) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - Independent multi-agent cinematic production suite (25 Role-Card agents, 64 skills, Production Bible workflow, Character DNA locking, native Grok Imagine Video 1.5 support) for Grok Build.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,247 | 🐛 1,309 | 🌐 TypeScript | 📅 2026-09-04
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 773 | 🐛 43 | 🌐 Go | 📅 2026-09-04 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 212,046 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 773 | 🐛 43 | 🌐 Go | 📅 2026-09-04 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
* [Engramory](https://github.com/tinqiao-oss/engramory) ⭐ 185 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Curated, file-based long-term memory for DSH agents — plain markdown notes in one store shared across hosts, with the index size cap enforced as a monotonic `ctx.tools.guard()` refusal rather than a reminder. Install: `dsh plugin --profile <name> add dsh-engramory`.
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 78 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
...
* **[zcode-ru](https://github.com/warment/zcode-ru) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04** — Russian (ru-RU) localization pack for the ZCode desktop app (3.10.1): 5,018 UI strings (100% of the renderer corpus), third language in the selector with English fallback, one-command installer with backup/restore. MIT.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 546 | 🐛 42 | 🌐 Python | 📅 2026-09-04 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 14,451 | 🐛 235 | 🌐 Python | 📅 2026-09-04 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,247 | 🐛 1,309 | 🌐 TypeScript | 📅 2026-09-04 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 919 | 🐛 25 | 🌐 Python | 📅 2026-09-04 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 212 | 🐛 354 | 🌐 Python | 📅 2026-09-04 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 546 | 🐛 42 | 🌐 Python | 📅 2026-09-04 to produce a trust score and security analysis.
