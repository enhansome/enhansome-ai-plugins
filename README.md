...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 455 | 🐛 39 | 🌐 Python | 📅 2026-08-20** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 4 | 🐛 1 | 📅 2026-08-19** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,699 | 🐛 40 | 🌐 Python | 📅 2026-08-17 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,097 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 3,992 | 🐛 7 | 🌐 Shell | 📅 2026-08-19 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,392 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-14 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,314 | 🐛 4 | 🌐 Python | 📅 2026-08-14 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,083 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 754 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-16 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 488 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-16 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 457 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-16 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 427 | 🐛 4 | 🌐 Go | 📅 2026-08-20 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 270 | 🐛 22 | 🌐 Python | 📅 2026-08-18 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 174 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-17 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 108 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-20 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 35 | 🐛 227 | 🌐 Python | 📅 2026-08-18 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Hera Agent Unity](https://github.com/NotNull92/hera-agent-unity) ⭐ 26 | 🐛 0 | 🌐 C# | 📅 2026-08-19 - Controls and verifies a live Unity Editor through a low-token CLI, with scene, asset, Inspector, Play Mode, test, screenshot, and runtime C# workflows for Codex and other coding agents.
...
* [AgentPack](https://github.com/vishal2612200/agentpack) ⭐ 24 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - Ranks repo context for Codex with likely files, skill recommendations, agent rules, commands, warnings, and compact task-focused packs before editing.
...
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-18 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-08-19 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [BABOK Analyst](https://github.com/GSkuza/BABOK_ANALYST) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - BABOK v3 business analysis agent with 16 MCP tools, a 9-stage pipeline, and human-in-the-loop approval gates.
...
* [ArmorCodex](https://github.com/armoriq/armorCodex) ⭐ 5 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-18 - Intent-based security for Codex with MCP plan registration, policy gating, CSRG cryptographic proofs, and audit logging on `bash` and `apply_patch`.
...
* [Maestro](https://github.com/mbanderas/maestro) ⭐ 4 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-13 - Opt-in local multi-CLI fusion engine and orchestration doctrine that fans a prompt across model CLIs, then judges and synthesizes one grounded answer.
* [Simple Man](https://github.com/Maksim-Burtsev/simple-man) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - High-compression communication mode for Codex agents that removes filler while preserving search, validation, and implementation effort.
...
* [HOL Guard Plugin](https://github.com/hashgraph-online/hol-guard-plugin) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-20 - AI antivirus workflow for Codex, Claude Code, Cursor, Gemini, OpenCode, MCP servers, skills, and plugin release checks with local approvals and receipts.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-08-20 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 12,145 | 🐛 120 | 🌐 JavaScript | 📅 2026-08-20 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 986 | 🐛 4 | 🌐 Python | 📅 2026-08-18 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 760 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 644 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 575 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 255 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-06 - Publish short-form videos to TikTok, Instagram Reels, YouTube Shorts, X, and Facebook from Codex with the Taisly MCP server and bundled social media posting skill.
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 207 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
* [Codex Usage Tracker](https://github.com/douglasmonsky/codex-usage-tracker) ⭐ 195 | 🐛 11 | 🌐 Python | 📅 2026-08-20 - Track aggregate Codex token usage from local session logs with MCP tools for summaries, session detail, CSV export, and dashboard generation.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 192 | 🐛 1 | 🌐 Go | 📅 2026-08-19 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 184 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 175 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-18 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 99 | 🐛 3 | 🌐 Python | 📅 2026-06-29 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 80 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-20 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [ScrapeGraph AI](https://github.com/ScrapeGraphAI/just-scrape) ⭐ 48 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-17 - AI-powered web scraping CLI to search, scrape, extract structured JSON, crawl, and monitor web pages via the ScrapeGraph AI API.
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 48 | 🐛 3 | 🌐 Python | 📅 2026-08-19 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 15 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [Dodo Payments](https://github.com/dodopayments/dodo-agent-plugin) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-17 - Payments integration for checkouts, subscriptions, and billing with live API and documentation MCP servers with browser OAuth.
...
* [CarsXE](https://github.com/carsxe/carsxe-codex-plugin) ⭐ 0 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-13 - Decode VINs, license plates, market value, vehicle history, recalls, liens, OBD codes, and more via the CarsXE API.
...
* [Coolify](https://github.com/Sevi-py/coolify-codex-plugin) ⭐ 0 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-14 - Control Coolify Cloud and self-hosted Coolify instances through API-aware workflow skills and local tools.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 157 | 🐛 139 | 🌐 Python | 📅 2026-08-19
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 25,755 | 🐛 0 | 🌐 Rust | 📅 2026-08-19
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 6,954 | 🐛 1,153 | 🌐 TypeScript | 📅 2026-08-20
before submitting.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 171,817 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 455 | 🐛 39 | 🌐 Python | 📅 2026-08-20 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 10,490 | 🐛 221 | 🌐 Python | 📅 2026-08-20 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 6,954 | 🐛 1,153 | 🌐 TypeScript | 📅 2026-08-20 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 828 | 🐛 32 | 🌐 Python | 📅 2026-08-19 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 157 | 🐛 139 | 🌐 Python | 📅 2026-08-19 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 455 | 🐛 39 | 🌐 Python | 📅 2026-08-20 to produce a trust score and security analysis.
