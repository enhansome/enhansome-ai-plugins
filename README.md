...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,359 | 🐛 26 | 🌐 Python | 📅 2026-08-09 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,041 | 🐛 4 | 🌐 Shell | 📅 2026-08-08 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
...
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,307 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 737 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-10 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 479 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-12 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 34 | 🐛 222 | 🌐 Python | 📅 2026-08-12 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Alcove](https://github.com/epicsagas/alcove) ⭐ 15 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - Local-first MCP server for private project docs with hybrid BM25+vector search, tree-sitter code indexing, and automated linting for team-wide documentation standards.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-08-12 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-07 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
* [Agent Deck](https://github.com/not-so-fat/agent-deck) ⭐ 0 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-12 - One MCP for context management: bind self-improving playbooks, MCP tools, and API keys to the session.
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 541 | 🐛 0 | 🌐 Python | 📅 2026-08-09 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 169 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-11 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 26 | 🐛 1 | 🌐 Python | 📅 2026-08-11 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 795 | 🐛 19 | 🌐 Python | 📅 2026-08-10 - Codex-focused catalog that inspired this cross-platform list.
