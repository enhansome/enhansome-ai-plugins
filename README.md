...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 554 | 🐛 38 | 🌐 Python | 📅 2026-09-05** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-05** — recommended for security, optional for listing
...
* [Planning with Files](https://github.com/OthmanAdi/planning-with-files) ⭐ 26,640 | 🐛 8 | 🌐 Shell | 📅 2026-09-02 - Persistent file-based planning for Claude Code, Codex, and other AI coding agents, preserving task plans, findings, and progress across context loss, crashes, and compaction.
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,563 | 🐛 12 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Browser Harness](https://github.com/browser-use/browser-harness) ⭐ 17,385 | 🐛 318 | 🌐 Python | 📅 2026-09-05 - MCP server and agent skill that connect an AI agent to a real browser through one editable CDP WebSocket.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,220 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [avoid-ai-writing](https://github.com/conorbronsdon/avoid-ai-writing) ⭐ 4,120 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-05 - Portable agent skill for auditing and rewriting AI-patterned prose, with an optional local MCP detector that calls no model and sends no text to a network service.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,048 | 🐛 1 | 🌐 Shell | 📅 2026-09-05 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,248 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,577 | 🐛 38 | 🌐 Dockerfile | 📅 2026-09-05 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Better Harness](https://github.com/QoderAI/better-harness) ⭐ 2,168 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-04 - Evidence-backed workflow analysis for coding agents that turns project and session signals into prioritized, verifiable improvements across supported hosts.
...
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,449 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,170 | 🐛 2 | 🌐 Python | 📅 2026-09-05 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 784 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-02 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 472 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [MisakaNet](https://github.com/Ikalus1988/MisakaNet) ⭐ 439 | 🐛 70 | 🌐 Python | 📅 2026-09-05 - Git-backed failure-memory for AI coding agents with 290 indexed lessons, MCP server with 5 tools (search, get\_lesson, submit\_usage, submit\_intake, usage\_status), and DeepSeekHarness adapter.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 433 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
* [AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 328 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-04 - Local bidirectional bridge that keeps Claude Code and Codex live as peers in one session, with mid-turn injection and quota-window handoff.
* [Audio Plugin Coder](https://github.com/Noizefield/audio-plugin-coder) ⭐ 314 | 🐛 1 | 🌐 C++ | 📅 2026-08-31 - Agent-agnostic JUCE workflow for building VST3/AU plugins from idea through design, implementation, test, and installer packaging.
...
* [Knowledge Manager](https://github.com/treylom/knowledge-manager) ⭐ 231 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Extracts and organizes content from web pages, files, Notion, and images into an Obsidian knowledge vault with GraphRAG-backed search, exporting to Notion, Markdown, and PDF.
...
* [claude-remember](https://github.com/Digital-Process-Tools/claude-remember) ⭐ 165 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - Persistent memory for Claude Code with identity, context, and continuity carried across sessions.
* [trace-mcp](https://github.com/nikolai-vysotskyi/trace-mcp) ⭐ 133 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05 - Precomputed code-intelligence graph served over MCP — symbol search, call graphs, change impact, and test mapping as structured answers instead of whole-file reads.
...
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 130 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-05 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
* [codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 117 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 - Switch Codex CLI and Desktop accounts with isolated `CODEX_HOME` profile directories instead of copying token files.
...
* [Coordinate Agents](https://github.com/hogancv/coordinate-agents) ⭐ 102 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-05 - Plugin-first multi-agent coordination tool with a local-first, recoverable Agent Bus and human-gated planning, implementation, review, and release workflows.
* [2718lab DevKit](https://github.com/2718labs/2718lab-devkit) ⭐ 101 | 🐛 2 | 🌐 Python | 📅 2026-09-05 - Codex-first local MCP server and skill bundle for deterministic project intelligence, durable workflow orchestration, and reusable engineering tools.
...
* [Mycelium](https://github.com/arjunrajlaboratory/mycelium) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Gives Claude Code and Codex analytical repositories durable memory for decisions, findings, provenance, reusable conventions, and analysis workflows.
...
* [MCP Video Analyzer](https://github.com/guimatheus92/mcp-video-analyzer) ⭐ 58 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-04 - Gives agents video input: transcript, key frames, OCR text, metadata, and an annotated timeline from Loom, YouTube, Instagram, TikTok, direct URLs, or a local file, over MCP, a one-shot CLI, or the /video skill.
...
* [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) ⭐ 54 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-05 - Whale-girl desktop pet for the DSH Web UI with pat-to-raise growth, work-state poses, 494 dialogue lines, 30 achievements and a built-in settings panel; local-first, zero telemetry.
* [Honcho](https://github.com/plastic-labs/codex-honcho) ⭐ 50 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01 - Persistent cross-session memory for Codex powered by Honcho — lifecycle hooks capture each session and inject relevant context back at session start, so Codex remembers your preferences, projects, and decisions across restarts.
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 49 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
* [Dely](https://github.com/hieuphung97/dely) ⭐ 48 | 🐛 1 | 🌐 Shell | 📅 2026-09-05 - Multi-harness control protocol that turns requests into approved design contracts, orchestrating isolated worker sessions for sequential implementation and independent code reviews under Orca supervision for Claude Code, Codex, Cursor, Antigravity, and other AI coding agents.
...
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
...
* [iris-agentic-dev](https://github.com/intersystems-community/iris-agentic-dev) ⭐ 38 | 🐛 7 | 🌐 Rust | 📅 2026-09-03 - MCP server giving AI assistants live access to InterSystems IRIS — execute ObjectScript, query globals, inspect productions, run tests, search code, and manage skills.
* [Knowledge Loom](https://github.com/magickaichen/knowledge-loom) ⭐ 37 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 - Agent-neutral skills for initializing, auditing, using, and maintaining governed local Markdown knowledge vaults across Agent Skills-compatible runtimes.
...
* [silica](https://github.com/kiycoh/silica-harness) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - Serves an Obsidian vault as the agent's memory over MCP: semantic and literal recall, gated note writing, and hooks that open each session already knowing its vault.
* [BioNexus](https://github.com/HERRY423/BioNexus) ⭐ 29 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - Warrant-first scientific reliability layer for AI bioinformatics that audits analytical assumptions, calibrates evidence strength, caps unsupported claims, and verifies execution provenance.
...
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 28 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
...
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-04 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 26 | 🐛 3 | 🌐 Shell | 📅 2026-09-05 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [ThumbGate](https://github.com/IgorGanapolsky/ThumbGate) ⭐ 26 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-04 - Pre-action infrastructure firewall for AI coding agents: feedback becomes lessons and prevention rules enforced by PreToolUse hooks across Claude Code, Codex, Gemini, and MCP.
...
* [Jump Skills](https://github.com/fabricioctelles/jump-skills) ⭐ 24 | 🐛 0 | 🌐 Shell | 📅 2026-09-03 - Meta-skills that route requests to specialized skills across Claude Code, Codex, Cursor, OpenCode, and other agent hosts.
...
* [mcp-zuul](https://github.com/imatza-rh/mcp-zuul) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-09-05 - MCP server for Zuul CI with 48 tools for build analysis, failure diagnosis, log search, flaky job detection, pipeline status, and live console streaming.
...
* [SOTA Engineering Skills](https://github.com/martinholovsky/SOTA-skills) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-09-04 - Router-mapped library of 40 domain and language skills with BUILD and AUDIT modes, loading only the rules a task needs and ending every rules file in an audit checklist.
* [VASTlint](https://github.com/aleksUIX/vastlint) ⭐ 18 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - Validate VAST, VMAP, and DAAST ad tags against IAB Tech Lab specs via Gemini CLI, Claude Code, and a hosted MCP server.
* [UIZZE](https://github.com/uizze/uizze) ⭐ 17 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-01 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
* [aide](https://github.com/jmylchreest/aide) ⭐ 16 | 🐛 1 | 🌐 Go | 📅 2026-09-05 - Persistent memory, code intelligence, and multi-agent orchestration for Claude Code, OpenCode, and Codex CLI via skills, hooks, and an MCP server.
...
* [claude-supertool](https://github.com/Digital-Process-Tools/claude-supertool) ⭐ 16 | 🐛 84 | 🌐 Python | 📅 2026-09-05 - Batches file, git and tracker operations into one round-trip, collapsing many reads, greps and globs into a single call for fewer output tokens and less wall time.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 11 | 🐛 15 | 🌐 Python | 📅 2026-09-05 - Interactive cross-filter dashboards for large datasets with a Claude Code skill for agent-driven data exploration.
...
* [LoreConvo](https://github.com/labyrinth-analytics/loreconvo) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - Persistent session memory MCP server for Claude — auto-saves and recalls conversation context, decisions, and artifacts across Claude Code, chat, and other surfaces with full-text search.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-09-05 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 8 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-05 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [BABOK Analyst](https://github.com/GSkuza/BABOK_ANALYST) ⭐ 7 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-03 - BABOK v3 business analysis agent with 16 MCP tools, a 9-stage pipeline, and human-in-the-loop approval gates.
...
* [Windrunner](https://github.com/shzlw/windrunner) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - Self-hosted project workspace with Spring AI, MCP, CLI, and multi-provider AI integrations.
...
* [ArmorCodex](https://github.com/armoriq/armorCodex) ⭐ 5 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-05 - Intent-based security for Codex with MCP plan registration, policy gating, CSRG cryptographic proofs, and audit logging on `bash` and `apply_patch`.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-09-04 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 3 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-05 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
* [River Review](https://github.com/s977043/river-review) ⭐ 3 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-05 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [claude-jit-context](https://github.com/Digital-Process-Tools/claude-jit-context) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-05 - Project knowledge that loads only when it is needed, matched against the prompt, the file being touched, or the tool being run instead of sitting in context all session.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-05 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Mermail Skills](https://github.com/Nudgen-Marketing/mermail-skills) ⭐ 1 | 🐛 111 | 🌐 JavaScript | 📅 2026-09-03 - Official Mermail Agent Skills and Codex plugin that connect AI assistants to hosted Mermail MCP for inbox, scheduling, GTM, support, and x402 wallet workflows.
...
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
* [FinBridge](https://github.com/Jakechj/finbridge-mcp) ⭐ 0 | 🐛 0 | 📅 2026-09-02 - Remote MCP server for Korean and US market data with filings, screeners, insider activity, and portfolio backtests.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 15,074 | 🐛 157 | 🌐 JavaScript | 📅 2026-09-05 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,112 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,092 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 955 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 793 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 731 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
...
* [Telnyx](https://github.com/team-telnyx/ai) ⭐ 212 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-05 - Telnyx toolkit for AI agents bundling Claude Code, Cursor, Gemini CLI, and OpenCode plugins, an agent toolkit for OpenAI/LangChain/CrewAI/Vercel AI SDK, a hosted MCP server, and a one-command CLI for messaging, voice, numbers, and account management.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 200 | 🐛 0 | 🌐 Go | 📅 2026-09-04 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 184 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Zero Slop](https://github.com/manavmishra/ZeroSlop) ⭐ 109 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Say no to AI slop: a human-in-the-loop learning agentic workflow skill that scores text 0-100 for AI slop and rewrites it tastefully, with a standard-library Python scorer that has zero dependencies and runs offline.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 87 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-27 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 85 | 🐛 1 | 🌐 Go | 📅 2026-09-05 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
* [Jenkins CLI](https://github.com/avivsinai/jenkins-cli) ⭐ 84 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - GitHub CLI-style interface for Jenkins controllers with jobs, pipelines, runs, logs, artifacts, credentials, and nodes.
* [Cortex](https://github.com/cdeust/Cortex) ⭐ 71 | 🐛 15 | 🌐 Python | 📅 2026-09-05 - Persistent thermodynamic memory and cognitive-profiling MCP server for Claude Code, Codex, and Gemini CLI — heat/decay dynamics, predictive-coding write gates, knowledge graph, and intent-aware recall across sessions.
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 57 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 32 | 🐛 3 | 🌐 Python | 📅 2026-09-01 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 17 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [Scholar Feed](https://github.com/YGao2005/scholar-feed-mcp) ⭐ 10 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - MCP server over 600k+ CS/AI/ML papers: rank by citations or forecast rising impact, trace 23.2M citation edges, and pull full text and BibTeX; `npx -y scholar-feed-mcp`.
...
* [AxonFlow](https://github.com/getaxonflow/axonflow-codex-plugin) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2026-09-03 - Runtime governance for Codex with policy enforcement on terminal commands, advisory checks for non-terminal tools via skills, PII/secret detection, and compliance-grade audit trails. Self-hosted via Docker.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 220 | 🐛 359 | 🌐 Python | 📅 2026-09-04
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,492 | 🐛 0 | 🌐 Rust | 📅 2026-09-01
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,262 | 🐛 1,312 | 🌐 TypeScript | 📅 2026-09-05
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 777 | 🐛 45 | 🌐 Go | 📅 2026-09-05 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 212,923 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 777 | 🐛 45 | 🌐 Go | 📅 2026-09-05 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
...
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 82 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 554 | 🐛 38 | 🌐 Python | 📅 2026-09-05 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 14,555 | 🐛 197 | 🌐 Python | 📅 2026-09-05 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,262 | 🐛 1,312 | 🌐 TypeScript | 📅 2026-09-05 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 927 | 🐛 25 | 🌐 Python | 📅 2026-09-05 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 220 | 🐛 359 | 🌐 Python | 📅 2026-09-04 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 554 | 🐛 38 | 🌐 Python | 📅 2026-09-05 to produce a trust score and security analysis.
