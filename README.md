...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 593 | 🐛 52 | 🌐 Python | 📅 2026-09-11** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-11** — recommended for security, optional for listing
...
* [Planning with Files](https://github.com/OthmanAdi/planning-with-files) ⭐ 26,798 | 🐛 9 | 🌐 Python | 📅 2026-09-09 - Persistent file-based planning for Claude Code, Codex, and other AI coding agents, preserving task plans, findings, and progress across context loss, crashes, and compaction.
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,841 | 🐛 15 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Browser Harness](https://github.com/browser-use/browser-harness) ⭐ 17,490 | 🐛 337 | 🌐 Python | 📅 2026-09-07 - MCP server and agent skill that connect an AI agent to a real browser through one editable CDP WebSocket.
* [avoid-ai-writing](https://github.com/conorbronsdon/avoid-ai-writing) ⭐ 4,303 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-10 - Portable agent skill for auditing and rewriting AI-patterned prose, with an optional local MCP detector that calls no model and sends no text to a network service.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,262 | 🐛 3 | 🌐 Shell | 📅 2026-09-08 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,061 | 🐛 1 | 🌐 Shell | 📅 2026-09-10 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,272 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,584 | 🐛 73 | 🌐 Dockerfile | 📅 2026-09-11 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Better Harness](https://github.com/QoderAI/better-harness) ⭐ 2,259 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-11 - Evidence-backed workflow analysis for coding agents that turns project and session signals into prioritized, verifiable improvements across supported hosts.
...
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,471 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,179 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 796 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-02 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 490 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [MisakaNet](https://github.com/Ikalus1988/MisakaNet) ⭐ 490 | 🐛 33 | 🌐 HTML | 📅 2026-09-11 - Git-backed failure-memory for AI coding agents with 290 indexed lessons, MCP server with 5 tools (search, get\_lesson, submit\_usage, submit\_intake, usage\_status), and DeepSeekHarness adapter.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 434 | 🐛 2 | 🌐 Go | 📅 2026-09-11 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
* [AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 336 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-10 - Local bidirectional bridge that keeps Claude Code and Codex live as peers in one session, with mid-turn injection and quota-window handoff.
* [Audio Plugin Coder](https://github.com/Noizefield/audio-plugin-coder) ⭐ 317 | 🐛 1 | 🌐 C++ | 📅 2026-09-07 - Agent-agnostic JUCE workflow for building VST3/AU plugins from idea through design, implementation, test, and installer packaging.
* [Reviewable HTML Workbench](https://github.com/u-ichi/reviewable-html-workbench) ⭐ 298 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Generate reviewable HTML documents, serve previews, collect inline review comments, and feed review outcomes back into agent workflows.
...
* [OpenCode Orchestrator](https://github.com/agnusdei1207/opencode-orchestrator) ⭐ 244 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Multi-agent mission control for OpenCode with Commander, Planner, Worker, and Reviewer workflows.
...
* [Oh My Design](https://github.com/3x-haust/oh-my-design) ⭐ 187 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-06 - Evidence-backed design workflow for Claude Code and Codex with reference research, multi-agent reviews, visual QA, and anti-slop guardrails.
...
* [trace-mcp](https://github.com/nikolai-vysotskyi/trace-mcp) ⭐ 175 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-11 - Precomputed code-intelligence graph served over MCP — symbol search, call graphs, change impact, and test mapping as structured answers instead of whole-file reads.
* [claude-remember](https://github.com/Digital-Process-Tools/claude-remember) ⭐ 168 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Persistent memory for Claude Code with identity, context, and continuity carried across sessions.
* [keep-the-why](https://github.com/oliver-zehentleitner/keep-the-why) ⭐ 156 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Preserves the reasoning behind a codebase as project memory — decisions, rejected alternatives, workarounds, incident learnings, constraints.
* [codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 142 | 🐛 0 | 🌐 Shell | 📅 2026-09-09 - Switch Codex CLI and Desktop accounts with isolated `CODEX_HOME` profile directories instead of copying token files.
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 135 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-11 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 107 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-11 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
* [Coordinate Agents](https://github.com/hogancv/coordinate-agents) ⭐ 102 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10 - Plugin-first multi-agent coordination tool with a local-first, recoverable Agent Bus and human-gated planning, implementation, review, and release workflows.
...
* [sci-brain](https://github.com/QuantumBFS/sci-brain) ⭐ 91 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Research skills plugin for Claude Code, Codex, OpenCode, and pi that surveys literature into a citable knowledge base, brainstorms research ideas, and drafts papers and slides.
...
* [pstack for Codex](https://github.com/Aqua-123/pstack-for-codex) ⭐ 65 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-08 - Codex-native engineering workflows derived from pstack, with 45 explicit skills and 23 Poteto Mode playbooks.
* [claude-image-gen](https://github.com/guinacio/claude-image-gen) ⭐ 63 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-08 - AI-powered image generation using Google Gemini or OpenAI (gpt-image-2), integrated with Claude Code via Skills or Claude.ai via MCP.
...
* [MCP Video Analyzer](https://github.com/guimatheus92/mcp-video-analyzer) ⭐ 61 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 - Gives agents video input: transcript, key frames, OCR text, metadata, and an annotated timeline from Loom, YouTube, Instagram, TikTok, direct URLs, or a local file, over MCP, a one-shot CLI, or the /video skill.
...
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 59 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
* [mstar-harness](https://github.com/btspoony/mstar-harness) ⭐ 58 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-11 - Multi-agent code harness plugin that routes work through PM, dev, QC, and QA roles with deterministic workflow gates enforced by a TypeScript engine, installable across dsh, omp, OpenCode, Cursor, Kimi Code, ZCode, and Codex.
* [Dely](https://github.com/hieuphung97/dely) ⭐ 57 | 🐛 1 | 🌐 Shell | 📅 2026-09-08 - Multi-harness control protocol that turns requests into approved design contracts, orchestrating isolated worker sessions for sequential implementation and independent code reviews under Orca supervision for Claude Code, Codex, Cursor, Antigravity, and other AI coding agents.
...
* [silica](https://github.com/kiycoh/silica-harness) ⭐ 53 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Serves an Obsidian vault as the agent's memory over MCP: semantic and literal recall, gated note writing, and hooks that open each session already knowing its vault.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
* [Rootly MCP Server](https://github.com/rootlyhq/rootly-mcp-server) ⭐ 45 | 🐛 2 | 🌐 Python | 📅 2026-09-10 - Manage and resolve production incidents from MCP-compatible AI assistants through dynamically generated, access-controlled Rootly API tools.
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
...
* [Groundwork](https://github.com/etr/groundwork) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Comprehensive skills library for Claude Code and Codex that structures discovery, planning, design, TDD, debugging, validation, collaboration, and shipping.
* [memi](https://github.com/sarveshsea/memi) ⭐ 42 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 - Interface understanding and design-system memory for Codex, Claude Code, Cursor, and MCP agents with UI audits, Tailwind token extraction, shadcn registry workflows, and a bundled Codex plugin.
...
* [Knowledge Loom](https://github.com/magickaichen/knowledge-loom) ⭐ 40 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-11 - Agent-neutral skills for initializing, auditing, using, and maintaining governed local Markdown knowledge vaults across Agent Skills-compatible runtimes.
...
* [BioNexus](https://github.com/HERRY423/BioNexus) ⭐ 29 | 🐛 11 | 🌐 Python | 📅 2026-09-11 - Warrant-first scientific reliability layer for AI bioinformatics that audits analytical assumptions, calibrates evidence strength, caps unsupported claims, and verifies execution provenance.
* [Stark](https://github.com/f0d010c/stark) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2026-07-26 - UI/UX design plugin for AI coding agents with product-flow routing, platform-native interface guidance, asset planning, and shipped-reference analysis before code.
...
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 28 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-11 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
...
* [geml](https://github.com/geml-spec/geml) ⭐ 26 | 🐛 1 | 🌐 HTML | 📅 2026-09-11 - An agent-native markup language featuring deterministic block-level editing and built-in validation to ensure documents never drift or break during AI operations.
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 26 | 🐛 1 | 🌐 Shell | 📅 2026-09-11 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
* [ThumbGate](https://github.com/IgorGanapolsky/ThumbGate) ⭐ 26 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-10 - Pre-action infrastructure firewall for AI coding agents: feedback becomes lessons and prevention rules enforced by PreToolUse hooks across Claude Code, Codex, Gemini, and MCP.
...
* [Vanguard Frontier Agentic](https://github.com/VincentChuWaiChow/vanguard-frontier-agentic) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2026-09-08 - Multi-harness marketplace of skills, specialist agents, rules, and MCP references for guarded cloud, platform, compliance, and business workflows.
...
* [Rel.AI MCP](https://github.com/Kyne0328/rel-ai-mcp) ⭐ 19 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Brings Codex-style coding workflows to ChatGPT Web, connecting it to local development workspaces through MCP while using ChatGPT Web quota instead of Codex quota.
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 18 | 🐛 6 | 🌐 Rust | 📅 2026-09-11 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
* [harmonyos-skills](https://github.com/liasica/harmonyos-skills) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Offline mirror of 16,800+ HarmonyOS NEXT official docs packaged as a Codex / Claude Code skill and MCP server, so AI coding assistants answer ArkTS / ArkUI / API questions with cited sources.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 16 | 🐛 21 | 🌐 Python | 📅 2026-09-11 - Interactive cross-filter dashboards for large datasets with a Claude Code skill for agent-driven data exploration.
...
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-10 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
* [SEO Skills AI](https://github.com/seoskillsai/seo-skills-ai) ⭐ 15 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Universal SEO skill suite and technical audit engine for Claude Code, Cursor, Codex, and other agents, with first-party Python adapters and HOL plugin-scanner CI.
...
* [Kernel](https://github.com/ariaxhan/kernel-claude) ⭐ 13 | 🐛 10 | 🌐 Python | 📅 2026-09-10 - Claude Code plugin marketplace and Codex plugin: hooks that block destructive commands, spawn guards on subagent contracts, agentdb memory with recall-before-act, blind verifiers, deterministic review; install with `/plugin marketplace add ariaxhan/kernel-claude`.
...
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [Stvena](https://github.com/nccapo/stvena) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2026-09-10 - Terminal workspace for running Codex or Claude Code beside live diffs, full-file review, checks, staging, and precise code feedback.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [LLM Transpile](https://github.com/epicsagas/llm-transpile) ⭐ 5 | 🐛 5 | 🌐 HTML | 📅 2026-09-11 - Auto-compress .md, .html, and .txt files via PostToolUse hook, cutting context usage by up to 40% with zero workflow change.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 3 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-11 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [claude-jit-context](https://github.com/Digital-Process-Tools/claude-jit-context) ⭐ 2 | 🐛 4 | 🌐 Shell | 📅 2026-09-11 - Project knowledge that loads only when it is needed, matched against the prompt, the file being touched, or the tool being run instead of sitting in context all session.
...
* [falsegreen-skill](https://github.com/vinicq/falsegreen-skill) ⭐ 2 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-10 - Finds tests that stay green when the code they cover is broken, applying six ordered judgments over Python, TypeScript, JavaScript, and Robot Framework suites in Codex CLI and Claude Code.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 17 | 🌐 Python | 📅 2026-09-11 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
* [Metis](https://github.com/gkrtjd99/Metis) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-11 - Repository-level engineering orchestrator that delegates bounded discovery, planning, implementation, review, and verification to fresh subagents, isolates mutable tasks in Git worktrees with declared path ownership, and requires evidence-gated completion.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 15,721 | 🐛 167 | 🌐 JavaScript | 📅 2026-09-11 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [LetsFG](https://github.com/LetsFG/LetsFG) ⭐ 2,005 | 🐛 5 | 🌐 Python | 📅 2026-09-11 - Flight and hotel search and booking for AI agents across hundreds of airlines and the major booking sites, via a remote MCP server (Claude, ChatGPT, Cursor, Windsurf), CLI, Python/JS SDKs, and an Agent Skill, with free search after a one-time card connection and real airline PNRs on flight bookings.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 1,803 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 11 skills: post writing with 20 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,186 | 🐛 2 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,102 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 811 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 762 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [humanizer-ru](https://github.com/ilyautov/humanizer-ru) ⭐ 336 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Agent skill for Claude Code, Codex, Cursor and Gemini that rewrites Russian text to remove 64 AI-generation markers (bureaucratese, calques, ChatGPT fingerprints), with a corpus-calibrated scanner, audit mode and author-voice calibration.
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 231 | 🐛 0 | 🌐 Shell | 📅 2026-08-28 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
...
* [Telnyx](https://github.com/team-telnyx/ai) ⭐ 213 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-11 - Telnyx toolkit for AI agents bundling Claude Code, Cursor, Gemini CLI, and OpenCode plugins, an agent toolkit for OpenAI/LangChain/CrewAI/Vercel AI SDK, a hosted MCP server, and a one-command CLI for messaging, voice, numbers, and account management.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 207 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
* [Codex Usage Tracker](https://github.com/douglasmonsky/codex-usage-tracker) ⭐ 196 | 🐛 10 | 🌐 Python | 📅 2026-08-20 - Track aggregate Codex token usage from local session logs with MCP tools for summaries, session detail, CSV export, and dashboard generation.
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 195 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-04 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 186 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Backlot](https://github.com/brekkylab/backlot) ⭐ 153 | 🐛 20 | 🌐 Python | 📅 2026-09-11 - Local emulator for Slack, Gmail, Google Drive, GitHub, Jira, Notion, S3 and other enterprise SaaS APIs, reproducing their response shapes, pagination, auth and per-document ACLs over a corpus you supply, so agents and RAG pipelines can be tested with no vendor account; `backlot mcp` serves every source as MCP tools.
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 151 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-11 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 134 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
* [Zero Slop](https://github.com/manavmishra/ZeroSlop) ⭐ 117 | 🐛 5 | 🌐 Python | 📅 2026-09-11 - Say no to AI slop: a human-in-the-loop learning agentic workflow skill that scores text 0-100 for AI slop and rewrites it tastefully, with a standard-library Python scorer that has zero dependencies and runs offline.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 91 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-10 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 85 | 🐛 3 | 🌐 Go | 📅 2026-09-11 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [OpenAI-Compatible Images](https://github.com/Syh1906/openai-compatible-imagegen) ⭐ 48 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-11 - Generate, edit, and batch-process images through OpenAI-compatible APIs using a standalone skill or a Codex App plugin with a canvas for annotating edit requests.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 33 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
* [Substack MCP](https://github.com/conorbronsdon/substack-mcp) ⭐ 31 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-10 - Safe Substack creator operations across publications: rich drafts, Notes, analytics, and consented subscribers; long-form posts stay draft-only, while Notes publish immediately.
...
* [prompt-to-asset](https://github.com/MohamedAbdallah-14/prompt-to-asset) ⭐ 19 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-11 - Route image-generation prompts to 30+ models (DALL-E, Stable Diffusion, Flux, Midjourney, and more) through a single MCP interface. Install: `npm install -g prompt-to-asset`.
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 17 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [Context Pack](https://github.com/Rothschildiuk/context-pack) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2026-03-19 - Generate compact first-pass repository briefings for coding agents before deeper exploration.
...
* [Unified AI System](https://github.com/happy520ai/unified-ai-system) ⭐ 6 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-11 - Self-hosted AI gateway for Codex with provider-free prompt enhancement, nine governed MCP tools, and a credential-free Docker path.
...
* [SEO Dungeon](https://github.com/avalonreset/seo-dungeon) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Gamified local SEO audits that turn website issues into 16-bit dungeon battles for Codex, Claude, and Gemini CLI workflows.
...
* [ThoughtProof MCP](https://github.com/ThoughtProof/thoughtproof-mcp) ⭐ 1 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-11 - Local MCP pre-action verification for agents: mandate + proposed action → ALLOW/BLOCK/UNCERTAIN; execute only on ALLOW.
...
* [plori](https://github.com/plori-ai/codex-plugin) ⭐ 0 | 🐛 2 | 📅 2026-09-10 - Create and drive plori cloud agents (each an AI agent on its own cloud computer) over plori's remote MCP server, with OAuth auto-discovery.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 238 | 🐛 419 | 🌐 Python | 📅 2026-09-11
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,674 | 🐛 0 | 🌐 Rust | 📅 2026-09-09
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,340 | 🐛 1,347 | 🌐 TypeScript | 📅 2026-09-11
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 802 | 🐛 30 | 🌐 Go | 📅 2026-09-11 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
* [HTML/CSS to Image API](https://github.com/htmlcsstoimage/agent-plugins) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - Let AI agents capture live website screenshots, render HTML/CSS and populate reusable templates as images or PDFs without managing a browser.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 220,341 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-11
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 802 | 🐛 30 | 🌐 Go | 📅 2026-09-11 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
* [humanizer-ru](https://github.com/ilyautov/humanizer-ru) ⭐ 336 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Text-only `dsh.bundle` that mounts the humanizer-ru Agent Skill into DeepSeek Harness: rewrites Russian text to remove 64 markers of AI generation, with a corpus-calibrated scanner and audit mode; install with `dsh plugin --profile web add humanizer-ru` (npm) or `github:ilyautov/humanizer-ru`.
...
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 105 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-06 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 593 | 🐛 52 | 🌐 Python | 📅 2026-09-11 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 15,345 | 🐛 313 | 🌐 Python | 📅 2026-09-09 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,340 | 🐛 1,347 | 🌐 TypeScript | 📅 2026-09-11 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 989 | 🐛 19 | 🌐 Python | 📅 2026-09-11 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 238 | 🐛 419 | 🌐 Python | 📅 2026-09-11 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 593 | 🐛 52 | 🌐 Python | 📅 2026-09-11 to produce a trust score and security analysis.
