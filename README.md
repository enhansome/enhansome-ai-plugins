...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 511 | 🐛 44 | 🌐 Python | 📅 2026-09-01** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-08-31** — recommended for security, optional for listing
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,363 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,201 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,026 | 🐛 17 | 🌐 Shell | 📅 2026-08-31 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,245 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,576 | 🐛 44 | 🌐 Dockerfile | 📅 2026-09-01 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Better Harness](https://github.com/QoderAI/better-harness) ⭐ 2,129 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-01 - Evidence-backed workflow analysis for coding agents that turns project and session signals into prioritized, verifiable improvements across supported hosts.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,442 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,322 | 🐛 3 | 🌐 Python | 📅 2026-08-28 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,162 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 780 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 504 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-31 - Spend less context and keep the conclusions across 16 coding clients including Claude Code, Codex, Gemini CLI, Cursor, and Copilot — diff-only re-reads, paths-only search, out-of-context stashing, and a local ledger that measures each tool's actual return.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 469 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 433 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 281 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
...
* [claude-remember](https://github.com/Digital-Process-Tools/claude-remember) ⭐ 163 | 🐛 12 | 🌐 Python | 📅 2026-08-29 - Persistent memory for Claude Code with identity, context, and continuity carried across sessions.
* [Krypton](https://github.com/jturntdev/krypton) ⭐ 129 | 🐛 2 | 🌐 Shell | 📅 2026-07-24 - Goal-based planning and proof gate for Codex and Claude Code that turns requests into ownership, cutover, review-gate, and acceptance-evidence plans.
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 129 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [Coordinate Agents](https://github.com/hogancv/coordinate-agents) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-01 - Plugin-first multi-agent coordination tool with a local-first, recoverable Agent Bus and human-gated planning, implementation, review, and release workflows.
* [trace-mcp](https://github.com/nikolai-vysotskyi/trace-mcp) ⭐ 102 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01 - Precomputed code-intelligence graph served over MCP — symbol search, call graphs, change impact, and test mapping as structured answers instead of whole-file reads.
...
* [Globalping](https://github.com/jsdelivr/globalping-mcp-server) ⭐ 63 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Access thousands of probes around the world to run network tests such as ping, traceroute, http, dns and mtr.
...
* [skillsaw](https://github.com/stbenjam/skillsaw) ⭐ 60 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - A configurable linter for agent skills, plugins, and AI coding assistant context.
* [pstack for Codex](https://github.com/Aqua-123/pstack-for-codex) ⭐ 58 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Codex-native engineering workflows derived from pstack, with 45 explicit skills and 23 Poteto Mode playbooks.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 49 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-28 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 39 | 🐛 212 | 🌐 Python | 📅 2026-08-31 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [iris-agentic-dev](https://github.com/intersystems-community/iris-agentic-dev) ⭐ 36 | 🐛 6 | 🌐 Rust | 📅 2026-09-01 - MCP server giving AI assistants live access to InterSystems IRIS — execute ObjectScript, query globals, inspect productions, run tests, search code, and manage skills.
...
* [Dely](https://github.com/hieuphung97/dely) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2026-09-01 - Multi-harness control protocol that turns requests into approved design contracts, orchestrating isolated worker sessions for sequential implementation and independent code reviews under Orca supervision for Claude Code, Codex, Cursor, Antigravity, and other AI coding agents.
* [Labtasker](https://github.com/luocfprime/labtasker) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Queue and run independent ML inference, evaluation, and experiment tasks across long-lived Python or command workers with a Claude Code plugin and cross-agent skill.
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 25 | 🐛 5 | 🌐 Shell | 📅 2026-08-31 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [SOTA Engineering Skills](https://github.com/martinholovsky/SOTA-skills) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Router-mapped library of 40 domain and language skills with BUILD and AUDIT modes, loading only the rules a task needs and ending every rules file in an audit checklist.
...
* [Rel.AI MCP](https://github.com/Kyne0328/rel-ai-mcp) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - Brings Codex-style coding workflows to ChatGPT Web, connecting it to local development workspaces through MCP while using ChatGPT Web quota instead of Codex quota.
...
* [claude-supertool](https://github.com/Digital-Process-Tools/claude-supertool) ⭐ 16 | 🐛 119 | 🌐 Python | 📅 2026-08-29 - Batches file, git and tracker operations into one round-trip, collapsing many reads, greps and globs into a single call for fewer output tokens and less wall time.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-01 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-01 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [Simple Man](https://github.com/Maksim-Burtsev/simple-man) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - High-compression communication mode for Codex agents that removes filler while preserving search, validation, and implementation effort.
* [VillageSQL Skills](https://github.com/villagesql/villagesql-skills) ⭐ 5 | 🐛 1 | 📅 2026-08-31 - Skills for VillageSQL including building extensions from scratch and porting PostgreSQL extensions to VillageSQL.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
...
* [claude-jit-context](https://github.com/Digital-Process-Tools/claude-jit-context) ⭐ 1 | 🐛 6 | 🌐 Shell | 📅 2026-09-01 - Project knowledge that loads only when it is needed, matched against the prompt, the file being touched, or the tool being run instead of sitting in context all session.
...
* [Mermail Skills](https://github.com/Nudgen-Marketing/mermail-skills) ⭐ 1 | 🐛 86 | 🌐 JavaScript | 📅 2026-08-27 - Official Mermail Agent Skills and Codex plugin that connect AI assistants to hosted Mermail MCP for inbox, scheduling, GTM, support, and x402 wallet workflows.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 14,609 | 🐛 150 | 🌐 JavaScript | 📅 2026-09-01 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,088 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,058 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 783 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 713 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 633 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 182 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 148 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 85 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 16 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
...
* [AxonFlow](https://github.com/getaxonflow/axonflow-codex-plugin) ⭐ 3 | 🐛 1 | 🌐 Shell | 📅 2026-09-01 - Runtime governance for Codex with policy enforcement on terminal commands, advisory checks for non-terminal tools via skills, PII/secret detection, and compliance-grade audit trails. Self-hosted via Docker.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 203 | 🐛 281 | 🌐 Python | 📅 2026-09-01
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,326 | 🐛 0 | 🌐 Rust | 📅 2026-08-31
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,203 | 🐛 1,262 | 🌐 TypeScript | 📅 2026-09-01
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 749 | 🐛 34 | 🌐 Go | 📅 2026-09-01 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 207,803 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 749 | 🐛 34 | 🌐 Go | 📅 2026-09-01 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
* [Engramory](https://github.com/tinqiao-oss/engramory) ⭐ 180 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Curated, file-based long-term memory for DSH agents — plain markdown notes in one store shared across hosts, with the index size cap enforced as a monotonic `ctx.tools.guard()` refusal rather than a reminder. Install: `dsh plugin --profile <name> add dsh-engramory`.
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 63 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-30 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 511 | 🐛 44 | 🌐 Python | 📅 2026-09-01 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 14,046 | 🐛 279 | 🌐 Python | 📅 2026-09-01 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,203 | 🐛 1,262 | 🌐 TypeScript | 📅 2026-09-01 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 872 | 🐛 26 | 🌐 Python | 📅 2026-08-31 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 203 | 🐛 281 | 🌐 Python | 📅 2026-09-01 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 511 | 🐛 44 | 🌐 Python | 📅 2026-09-01 to produce a trust score and security analysis.
