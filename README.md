...
* [Engramory](https://github.com/tinqiao-oss/engramory) ⭐ 176 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Curated, file-based long-term memory for DSH agents — plain markdown notes in one store shared across hosts, with the index size cap enforced as a monotonic `ctx.tools.guard()` refusal rather than a reminder. Install: `dsh plugin --profile <name> add dsh-engramory`.
* [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) ⭐ 33 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-25 - Backup, restore, export, import, migrate and sync your complete DeepSeek Harness (DSH) configuration — settings, model providers, plugins, MCP servers, skills, agent presets and workspaces — and restore your whole environment on a new machine with one click.
* [MCP Migration Check](https://github.com/AlpayC/mcp-migration-check) ⭐ 5 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-26 - Deterministic MCP 2026-07-28 migration checker with an agent skill, CLI, GitHub Action, and hosted web probe powered by one rule engine.
...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 486 | 🐛 34 | 🌐 Python | 📅 2026-08-27** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 4 | 🐛 1 | 📅 2026-08-27** — recommended for security, optional for listing
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,061 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,171 | 🐛 3 | 🌐 Shell | 📅 2026-08-25 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,010 | 🐛 1 | 🌐 Shell | 📅 2026-08-27 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,218 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [MegaLinter](https://github.com/oxsecurity/megalinter) ⭐ 2,571 | 🐛 41 | 🌐 Dockerfile | 📅 2026-08-27 - Set up, run and fix MegaLinter on any repository, covering 100+ linters and formatters for 69+ languages and 23+ formats, in CI or locally, with per-linter fix guides for the agent.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,421 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-24 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,320 | 🐛 3 | 🌐 Python | 📅 2026-08-27 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,134 | 🐛 1 | 🌐 Python | 📅 2026-08-27 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 772 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-26 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
* [Boss](https://github.com/echoVic/boss-skill) ⭐ 550 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-23 - BMAD pipeline plugin that orchestrates a full requirements-to-deploy workflow across nine specialist agents with an auditable runtime DAG and quality gates, for Claude Code, Codex, OpenClaw, and Antigravity.
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 498 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 463 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-25 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 430 | 🐛 2 | 🌐 Shell | 📅 2026-08-27 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
* [Reviewable HTML Workbench](https://github.com/u-ichi/reviewable-html-workbench) ⭐ 292 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - Generate reviewable HTML documents, serve previews, collect inline review comments, and feed review outcomes back into agent workflows.
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 275 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
* [OpenCode Orchestrator](https://github.com/agnusdei1207/opencode-orchestrator) ⭐ 229 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Multi-agent mission control for OpenCode with Commander, Planner, Worker, and Reviewer workflows.
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 182 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-17 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
* [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) ⭐ 133 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-26 - An open-source Agent Skills pack for Claude Code and Codex covering multi-agent workflows, code review, design, copy, SEO, app shipping, creator-rights workflows, and local read-only MCP discovery.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 109 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
* [Sealos](https://github.com/labring/sealos-skills) ⭐ 77 | 🐛 6 | 🌐 Python | 📅 2026-08-14 - Deploy apps to Sealos Cloud from Codex with readiness checks, Dockerfile generation, Compose conversion, image builds, and rollout updates.
* [claude-image-gen](https://github.com/guinacio/claude-image-gen) ⭐ 59 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-22 - AI-powered image generation using Google Gemini or OpenAI (gpt-image-2), integrated with Claude Code via Skills or Claude.ai via MCP.
* [2718lab DevKit](https://github.com/2718labs/2718lab-devkit) ⭐ 53 | 🐛 2 | 🌐 Python | 📅 2026-08-27 - Codex-first local MCP server and skill bundle for deterministic project intelligence, durable workflow orchestration, and reusable engineering tools.
...
* [Honcho](https://github.com/plastic-labs/codex-honcho) ⭐ 50 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-16 - Persistent cross-session memory for Codex powered by Honcho — lifecycle hooks capture each session and inject relevant context back at session start, so Codex remembers your preferences, projects, and decisions across restarts.
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 49 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-25 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 37 | 🐛 203 | 🌐 Python | 📅 2026-08-27 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
* [Codebase Recon](https://github.com/yujiachen-y/codebase-recon-skill) ⭐ 35 | 🐛 0 | 📅 2026-04-26 - Analyze git history to understand a codebase before reading any code — auto-scales by repo size and cross-references hotspots with bug magnets to surface high-risk files, bus factor, and team momentum.
...
* [Open Dynamic Workflows](https://github.com/Suraj1235/open-dynamic-workflows) ⭐ 32 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-09 - Local-first MIT dynamic multi-agent workflows for Codex, OpenCode, Antigravity, Cursor, and VS Code with a daemon, MCP bridge, Codex skills, OpenCode plugin, and bring-your-own-model support.
* [Designer Skill](https://github.com/Pythoughts-labs/designer-skill) ⭐ 28 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-26 - Plug-and-play MCP that gives your agent UI superpowers. One install: design skill + MCP server, zero config.
...
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 27 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-27 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 24 | 🐛 12 | 🌐 Shell | 📅 2026-08-26 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
* [AgentPack](https://github.com/vishal2612200/agentpack) ⭐ 24 | 🐛 19 | 🌐 Python | 📅 2026-08-24 - Ranks repo context for Codex with likely files, skill recommendations, agent rules, commands, warnings, and compact task-focused packs before editing.
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 24 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-21 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
* [Frappe Agent](https://github.com/Dkm0315/frappe-agent) ⭐ 23 | 🐛 2 | 📅 2026-08-23 - Frappe and ERPNext coding, customization, bench, and review intelligence for Codex.
* [AI-Native SDLC](https://github.com/bashebr/ai-native-sdlc) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Reusable skill and plugin bundle implementing the AI-native SDLC workflow: plan, design, build, test, deploy, and maintain with human approval gates.
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2026-08-26 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
* [Supergraph](https://github.com/datit309/supergraph) ⭐ 21 | 🐛 0 | 🌐 Shell | 📅 2026-08-27 - Engineering workflow system for AI coding agents that enforces planning, TDD, verification, review, and architecture-aware decisions with local codebase graph intelligence across Claude Code, Codex CLI, Antigravity, and OpenCode,..
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 17 | 🐛 8 | 🌐 Rust | 📅 2026-07-23 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
...
* [SOTA Engineering Skills](https://github.com/martinholovsky/SOTA-skills) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Router-mapped library of 40 domain and language skills with BUILD and AUDIT modes, loading only the rules a task needs and ending every rules file in an audit checklist.
...
* [MeMesh](https://github.com/PCIRCLE-AI/memesh) ⭐ 15 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27 - Local SQLite memory shared by Claude Code, Codex, Gemini, Cursor, and other MCP clients, captured automatically by hooks from real work and injected at the moment the agent acts.
...
* [Project Autopilot](https://github.com/AlexMi64/codex-project-autopilot) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-04-09 - Turn an idea into a structured project workflow with planning, execution, verification, and handoff.
...
* [trigger-tree](https://github.com/Hedde/trigger_tree) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Local documentation telemetry for Claude Code and Codex: see which docs your agent actually reads, gate discoverability in CI, and measure instruction adherence.
...
* [Claude Watchdog](https://github.com/Temikus/claude-watchdog) ⭐ 11 | 🐛 2 | 🌐 Just | 📅 2026-08-26 - Stop hook that runs a critical post-mortem on every Claude Code session, cross-checking what was asked against the actual git diff for missed goals, wasted detours, and unverified claims.
* [Codex Agenteam](https://github.com/yimwoo/codex-agenteam) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-07-06 - Specialist AI agents (researcher, PM, architect, developer, QA, reviewer) orchestrated as a configurable team pipeline.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [LoreConvo](https://github.com/labyrinth-analytics/loreconvo) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - Persistent session memory MCP server for Claude — auto-saves and recalls conversation context, decisions, and artifacts across Claude Code, chat, and other surfaces with full-text search.
...
* [Agentic Ship](https://github.com/moasq/agentic-ship) ⭐ 9 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-23 - Cross-host product-development toolkit for Claude Code, Codex, Cursor, Hermes, and OpenClaw with shared rules, specialist roles, service connections, and machine-checked UI, backend, security, and launch gates.
* [Praxis](https://github.com/ouonet/praxis) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-26 - Intent-driven workflow skills for coding agents: describe what done looks like, not the steps. Triage-first design keeps token costs low across design, TDD, debug, review, and release.
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-08-27 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [BABOK Analyst](https://github.com/GSkuza/BABOK_ANALYST) ⭐ 7 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-26 - BABOK v3 business analysis agent with 16 MCP tools, a 9-stage pipeline, and human-in-the-loop approval gates.
...
* [Zagrosi Forge](https://github.com/zagrosi-code/zagrosi-forge) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-08-26 - Decompose broad project briefs into researched plans and implement sectioned work with TDD, quality gates, and traceability.
...
* [Maestro](https://github.com/mbanderas/maestro) ⭐ 5 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-20 - Opt-in local multi-CLI fusion engine and orchestration doctrine that fans a prompt across model CLIs, then judges and synthesizes one grounded answer.
...
* [VillageSQL Skills](https://github.com/villagesql/villagesql-skills) ⭐ 5 | 🐛 0 | 📅 2026-08-24 - Skills for VillageSQL including building extensions from scratch and porting PostgreSQL extensions to VillageSQL.
...
* [LoreDocs](https://github.com/labyrinth-analytics/loredocs) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - Knowledge vault MCP server for Claude — organizes durable project docs, specs, and guides with FTS5 search, tagging, and cross-project context loading.
...
* [Codex How To](https://github.com/Phelan164/codex-howto) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-08-27 - Engineering-first Codex curriculum and plugin with 9 skills, measured token-efficiency experiments, bounded orchestration, testing, review, and living knowledge maintenance.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [AIBoarding](https://github.com/gustavo-meilus/aiboarding) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2026-08-25 - Generate, maintain, compress, and audit standard AI-agent onboarding files with AGENTS.md, CLAUDE.md, drift tracking, and lifecycle hooks.
...
* [falsegreen-skill](https://github.com/vinicq/falsegreen-skill) ⭐ 2 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-24 - Finds tests that stay green when the code they cover is broken, applying six ordered judgments over Python, TypeScript, JavaScript, and Robot Framework suites in Codex CLI and Claude Code.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
* [River Review](https://github.com/s977043/river-review) ⭐ 2 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-27 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 5 | 🌐 Python | 📅 2026-08-27 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
* [GCF Proxy](https://github.com/blackwell-systems/gcf-codex-plugin) ⭐ 1 | 🐛 2 | 📅 2026-08-22 - Save 71% on MCP tool call tokens by wrapping any server with GCF encoding, with session stats hook and setup skill.
* [kgai](https://github.com/kgaidev/kgai) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - Shared decision memory for AI dev teams, an immutable local log of the decisions behind your code, synced over an S3 bucket you own.
...
* [RoadmapSmith](https://github.com/PapiScholz/roadmapsmith) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-23 - Evidence-backed ROADMAP.md workflows for AI coding agents with validation, sync, and roadmap generation across any tech stack.
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-26 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
* [Spellbook Skills](https://github.com/yyykf/spellbook-skills) ⭐ 1 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - Practical Claude Code and Codex skills for worktrees, PR/MR automation, review cleanup, YApi lookup, and Java DDD guidance.
...
* [Unforgit](https://github.com/MiguelMedeiros/unforgit-codex-plugin) ⭐ 1 | 🐛 1 | 📅 2026-08-21 - Git-backed repository memory for Codex and other coding agents via MCP, with durable local knowledge for decisions, conventions, gotchas, and playbooks.
...
* [Agent Deck](https://github.com/not-so-fat/agent-deck) ⭐ 0 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-27 - One MCP for context management: bind self-improving playbooks, MCP tools, and API keys to the session.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 13,909 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-27 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,080 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-27 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,028 | 🐛 4 | 🌐 Python | 📅 2026-08-20 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 772 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 698 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 605 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 232 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-06 - Publish short-form videos to TikTok, Instagram Reels, YouTube Shorts, X, and Facebook from Codex with the Taisly MCP server and bundled social media posting skill.
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 217 | 🐛 0 | 🌐 Shell | 📅 2026-08-27 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 195 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
...
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 188 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-27 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 180 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
* [Miro](https://github.com/miroapp/miro-ai) ⭐ 150 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-26 - Official Miro MCP server and agent integrations for Claude Code, Codex, Gemini CLI, Cursor, and other AI tools — read and write Miro boards, create diagrams, extract context from boards, and generate code from designs.
* [Hostinger API MCP](https://github.com/hostinger/api-mcp-server) ⭐ 144 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-27 - Manage Hostinger VPS, domains, DNS, hosting, and billing through MCP tools backed by the official Hostinger API.
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 85 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-27 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 83 | 🐛 5 | 🌐 Go | 📅 2026-08-27 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
* [Jenkins CLI](https://github.com/avivsinai/jenkins-cli) ⭐ 82 | 🐛 3 | 🌐 Go | 📅 2026-08-24 - GitHub CLI-style interface for Jenkins controllers with jobs, pipelines, runs, logs, artifacts, credentials, and nodes.
* [Cortex](https://github.com/cdeust/Cortex) ⭐ 71 | 🐛 15 | 🌐 Python | 📅 2026-08-25 - Persistent thermodynamic memory and cognitive-profiling MCP server for Claude Code, Codex, and Gemini CLI — heat/decay dynamics, predictive-coding write gates, knowledge graph, and intent-aware recall across sessions.
...
* [Nimble](https://github.com/Nimbleway/agent-skills) ⭐ 52 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Web Search Agents that search, browse, extract, and reason across live pages and return cited, schema-enforced results, with self-learning retrieval that improves accuracy and lowers cost per task on repeat work, plus Search and Extract skills for fast raw web data in Claude Code, Codex, Cursor, and Grok Build.
* [ScrapeGraph AI](https://github.com/ScrapeGraphAI/just-scrape) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24 - AI-powered web scraping CLI to search, scrape, extract structured JSON, crawl, and monitor web pages via the ScrapeGraph AI API.
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 51 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Talivia Agent Kit](https://github.com/talivia-group/agent) ⭐ 42 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-02 - Install and verify revenue-first website analytics from Codex, connect payment attribution, and identify which traffic sources and customer journeys become revenue.
...
* [Pronounce](https://github.com/anzy-renlab-ai/pronounce) ⭐ 35 | 🐛 1 | 🌐 Shell | 📅 2026-08-27 - Pronounce developer jargon out loud: an MCP server (lookup/search) and skill backed by a 1,721-entry sourced dictionary with IPA, audio, and cited pronunciations for kubectl, nginx, YAML, JWT, and more.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 30 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
* [Skill-Atlas](https://github.com/danielLublinsky/Skill-Atlas) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - A third tier for Claude Code skills — dormant, zero tokens, still findable. Search a graph of your collection instead of preloading it.
...
* [Kindle Highlights](https://github.com/l3a0/claude-plugins) ⭐ 17 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - Claude Code skill that exports a book's Kindle highlights to verbatim, location-cited Markdown, recovering the ones Amazon's export limit truncates or hides (macOS).
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-24 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
* [Thermal-Fluid Research Workflow](https://github.com/hanhuark/mechanical-engineering-research-skill) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Thermal-fluid mechanical engineering research workflow for literature review, technical writing, data analysis, presentations, proposals, coding, and AI/ML tools.
...
* [Codex Mem](https://github.com/2kDarki/codex-mem) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-23 - Automatically capture, compress, and inject session context back into future Codex sessions.
...
* [Val Town](https://github.com/val-town/plugins) ⭐ 10 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-19 - Build and deploy serverless TypeScript on Val Town from Codex — hosted MCP server plus skills for HTTP vals, cron, SQLite, email, OAuth, and React UI.
...
* [Dodo Payments](https://github.com/dodopayments/dodo-agent-plugin) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-24 - Payments integration for checkouts, subscriptions, and billing with live API and documentation MCP servers with browser OAuth.
...
* [Unified AI System](https://github.com/happy520ai/unified-ai-system) ⭐ 6 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-25 - Self-hosted AI gateway for Codex with provider-free prompt enhancement, nine governed MCP tools, and a credential-free Docker path.
...
* [AxonFlow](https://github.com/getaxonflow/axonflow-codex-plugin) ⭐ 3 | 🐛 2 | 🌐 Shell | 📅 2026-08-21 - Runtime governance for Codex with policy enforcement on terminal commands, advisory checks for non-terminal tools via skills, PII/secret detection, and compliance-grade audit trails. Self-hosted via Docker.
...
* [Cadence Code](https://github.com/michael-L-i/cadence-code) ⭐ 2 | 🐛 5 | 🌐 Python | 📅 2026-08-25 - Fully local voice conversations for Claude Code, Codex, Cursor, and Antigravity on Apple Silicon, with selectable MLX speech and transcription models.
...
* [OrgX](https://github.com/useorgx/orgx-codex-plugin) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-25 - MCP access and initiative-aware skills for organizational workflows.
...
* [AgentGuards](https://github.com/alelaguard/agentguards-plugins) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - LLM security guardrails for Codex with enforcing hooks and MCP tools: jailbreak and prompt-injection detection, web-content scanning, data-exfiltration blocking, and destructive-command authorization.
...
* [agentmailkit](https://github.com/ariaxhan/agentmailkit) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - MCP server for scheduled LLM-written email digests from RSS, web and local sources: tools list\_jobs/run\_job/preview\_job/list\_plugins, local-first, run\_job dry-run by default; `pip install "agentmailkit[mcp]"` then `agentmailkit mcp`.
...
* [CarsXE](https://github.com/carsxe/carsxe-codex-plugin) ⭐ 0 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - Decode VINs, license plates, market value, vehicle history, recalls, liens, OBD codes, and more via the CarsXE API.
* [Coolify](https://github.com/Sevi-py/coolify-codex-plugin) ⭐ 0 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-21 - Control Coolify Cloud and self-hosted Coolify instances through API-aware workflow skills and local tools.
...
* [plori](https://github.com/plori-ai/codex-plugin) ⭐ 0 | 🐛 2 | 📅 2026-08-24 - Create and drive plori cloud agents (each an AI agent on its own cloud computer) over plori's remote MCP server, with OAuth auto-discovery.
...
* [SolidWorks GPT Plugin](https://github.com/Erfouni/solidworks-GPT-plugin) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Knowledge-backed SolidWorks design and validation workflows for Codex with standards lookup, CAD evidence gates, and consent-based session learning.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 188 | 🐛 196 | 🌐 Python | 📅 2026-08-26
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,122 | 🐛 0 | 🌐 Rust | 📅 2026-08-25
before submitting.

* [Grok Imagine Cinematic Studio](https://github.com/FineComputer14451/Grok-Imagine-Cinematic-Studio) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Independent multi-agent cinematic production suite (25 Role-Card agents, 64 skills, Production Bible workflow, Character DNA locking, native Grok Imagine Video 1.5 support) for Grok Build.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,109 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-08-27
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 731 | 🐛 122 | 🌐 Go | 📅 2026-08-27 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 199,341 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 731 | 🐛 122 | 🌐 Go | 📅 2026-08-27 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 486 | 🐛 34 | 🌐 Python | 📅 2026-08-27 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 13,117 | 🐛 467 | 🌐 Python | 📅 2026-08-27 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,109 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-08-27 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 852 | 🐛 38 | 🌐 Python | 📅 2026-08-27 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 188 | 🐛 196 | 🌐 Python | 📅 2026-08-26 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 486 | 🐛 34 | 🌐 Python | 📅 2026-08-27 to produce a trust score and security analysis.
