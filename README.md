...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 481 | 🐛 34 | 🌐 Python | 📅 2026-08-26** — recommended local preflight
2. **Add the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 4 | 🐛 1 | 📅 2026-08-25** — recommended for security, optional for listing
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,003 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,157 | 🐛 3 | 🌐 Shell | 📅 2026-08-25 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,007 | 🐛 1 | 🌐 Shell | 📅 2026-08-26 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [AI Video Transcriber](https://github.com/wendy7756/AI-Video-Transcriber) ⭐ 3,210 | 🐛 10 | 🌐 Python | 📅 2026-08-23 - Transcribe and summarize videos, podcasts, and local media via a Codex plugin, Claude Code skill, and MCP server.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,418 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-24 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,320 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,133 | 🐛 5 | 🌐 Python | 📅 2026-08-24 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 767 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-26 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
* [Boss](https://github.com/echoVic/boss-skill) ⭐ 549 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-23 - BMAD pipeline plugin that orchestrates a full requirements-to-deploy workflow across nine specialist agents with an auditable runtime DAG and quality gates, for Claude Code, Codex, OpenClaw, and Antigravity.
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 498 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-26 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 461 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
...
* [Reviewable HTML Workbench](https://github.com/u-ichi/reviewable-html-workbench) ⭐ 291 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - Generate reviewable HTML documents, serve previews, collect inline review comments, and feed review outcomes back into agent workflows.
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 273 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
...
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 181 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-17 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 37 | 🐛 202 | 🌐 Python | 📅 2026-08-26 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Velith](https://github.com/epicsagas/Velith) ⭐ 32 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-09 - AI-native publishing system with a 6-phase pipeline from ideation to EPUB/PDF across 8 genres.
...
* [Designer Skill](https://github.com/Pythoughts-labs/designer-skill) ⭐ 27 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-26 - Plug-and-play MCP that gives your agent UI superpowers. One install: design skill + MCP server, zero config.
* [Knowl](https://github.com/dat999zx/knowl) ⭐ 27 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26 - Local-first project memory over MCP for Claude Code, Codex, Cursor and eight other hosts: a SQLite store that retires facts when they change, shares knowledge across linked repos, and retrieves it by hybrid search.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 24 | 🐛 11 | 🌐 Shell | 📅 2026-08-25 - Real-time secret-leak guardrails for AI coding agents (Claude Code, Codex), Git hooks, and CI.
...
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
...
* [Zagrosi Forge](https://github.com/zagrosi-code/zagrosi-forge) ⭐ 7 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - Decompose broad project briefs into researched plans and implement sectioned work with TDD, quality gates, and traceability.
...
* [HOL Guard Plugin](https://github.com/hashgraph-online/hol-guard-plugin) ⭐ 4 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-25 - AI antivirus workflow for Codex, Claude Code, Cursor, Gemini, OpenCode, MCP servers, skills, and plugin release checks with local approvals and receipts.
...
* [Codex How To](https://github.com/Phelan164/codex-howto) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - Engineering-first Codex curriculum and plugin with 9 skills, measured token-efficiency experiments, bounded orchestration, testing, review, and living knowledge maintenance.
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-26 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [Codex Process Jobs](https://github.com/joelfarthing/codex-process-jobs) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-25 - Run long local builds, tests, benchmarks, and inference jobs as durable detached processes with tracked status, bounded results, and completion delivery across Codex surfaces.
...
* [Logic Probe](https://github.com/AmethystLuna/logicprobe) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-26 - Design-document & plan claim verification — checks every verifiable claim against the codebase, escalates behavioral claims to executable-model verification (7 structural checks + 7 adversarial probes), and compares before/after models for refactoring regression detection.
* [River Review](https://github.com/s977043/river-review) ⭐ 2 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-26 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 13,664 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-26 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [CloudBase AI Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐ 1,079 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 - Backend for AI coding agents on Tencent CloudBase — database, auth, and functions via Plugin, Skills & MCP.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,017 | 🐛 4 | 🌐 Python | 📅 2026-08-20 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 771 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 693 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 600 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 217 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 179 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 111 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 82 | 🐛 3 | 🌐 Go | 📅 2026-08-26 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [Talivia Agent Kit](https://github.com/talivia-group/agent) ⭐ 43 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-02 - Install and verify revenue-first website analytics from Codex, connect payment attribution, and identify which traffic sources and customer journeys become revenue.
...
* [Pronounce](https://github.com/anzy-renlab-ai/pronounce) ⭐ 35 | 🐛 1 | 🌐 Shell | 📅 2026-08-14 - Pronounce developer jargon out loud: an MCP server (lookup/search) and skill backed by a 1,721-entry sourced dictionary with IPA, audio, and cited pronunciations for kubectl, nginx, YAML, JWT, and more.
...
* [Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet) ⭐ 29 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Hermes Agent X/Twitter plugin for read-first social research, monitoring, and approval-gated actions through Xquik.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 185 | 🐛 184 | 🌐 Python | 📅 2026-08-25
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 26,076 | 🐛 0 | 🌐 Rust | 📅 2026-08-25
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 7,085 | 🐛 1,189 | 🌐 TypeScript | 📅 2026-08-26
before submitting.

* [deja](https://github.com/vshulcz/deja-vu) ⭐ 728 | 🐛 81 | 🌐 Go | 📅 2026-08-26 - Recalls the sessions the other coding agents on the machine already wrote to disk, including work from before it was installed, through MCP tools, a `/deja:recall` command and recall on every prompt.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 197,106 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21
and the [`dsh-plugin` community topic](https://github.com/topics/dsh-plugin) before
submitting a repository.

* [dsh-deja](https://github.com/vshulcz/deja-vu) ⭐ 728 | 🐛 81 | 🌐 Go | 📅 2026-08-26 - Brings the session history of nineteen other coding agents into DeepSeek Harness: recall, session digest and per-file history tools over a local index, plus optional automatic recall.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 481 | 🐛 34 | 🌐 Python | 📅 2026-08-26 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 12,857 | 🐛 487 | 🌐 Python | 📅 2026-08-26 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 7,085 | 🐛 1,189 | 🌐 TypeScript | 📅 2026-08-26 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 846 | 🐛 37 | 🌐 Python | 📅 2026-08-25 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 185 | 🐛 184 | 🌐 Python | 📅 2026-08-25 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 481 | 🐛 34 | 🌐 Python | 📅 2026-08-26 to produce a trust score and security analysis.
