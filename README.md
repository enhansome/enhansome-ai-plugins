...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 457 | 🐛 32 | 🌐 Python | 📅 2026-08-21** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 4 | 🐛 1 | 📅 2026-08-21** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,750 | 🐛 7 | 🌐 Python | 📅 2026-08-21 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,105 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 3,992 | 🐛 9 | 🌐 Shell | 📅 2026-08-21 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,401 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
* [Antigravity Workspace Template](https://github.com/study8677/antigravity-workspace-template) ⭐ 1,317 | 🐛 3 | 🌐 Python | 📅 2026-08-14 - Multi-agent codebase knowledge graph generator with context-aware planning and automatic scope management — turns codebases into coherent agent workspaces.
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,088 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 758 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-16 - Spec-first workflow with nine skills, user-controlled Quick / Hotfix / Tweak / Full paths, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
* [Boss](https://github.com/echoVic/boss-skill) ⭐ 547 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-16 - BMAD pipeline plugin that orchestrates a full requirements-to-deploy workflow across nine specialist agents with an auditable runtime DAG and quality gates, for Claude Code, Codex, OpenClaw, and Antigravity.
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 489 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-16 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 456 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 427 | 🐛 5 | 🌐 Go | 📅 2026-08-21 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Ditto](https://github.com/ohad6k/ditto) ⭐ 272 | 🐛 22 | 🌐 Python | 📅 2026-08-18 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
* [Claude Code for Codex](https://github.com/sendbird/cc-plugin-codex) ⭐ 177 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-17 - Reverse of OpenAI's official Claude-hosted plugin: use Claude Code from Codex for reviews, rescue tasks, tracked background jobs, and hook-powered review gates.
...
* [Superloopy](https://github.com/beefiker/superloopy) ⭐ 108 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-21 - Evidence-gated Codex loop harness with specialist skills, including near-pixel authorized website cloning backed by screenshots, assets, build output, and visual QA.
* [Sealos](https://github.com/labring/sealos-skills) ⭐ 73 | 🐛 6 | 🌐 Python | 📅 2026-08-14 - Deploy apps to Sealos Cloud from Codex with readiness checks, Dockerfile generation, Compose conversion, image builds, and rollout updates.
* [Archcore](https://github.com/archcore-ai/plugin) ⭐ 52 | 🐛 15 | 🌐 Shell | 📅 2026-08-17 - Gives coding agents the architecture, rules, and prior decisions of the repo via skills, hooks, and MCP — so new changes land where the project says they belong across Claude Code, Cursor, and Codex CLI.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 47 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 35 | 🐛 212 | 🌐 Python | 📅 2026-08-21 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
* [Codebase Recon](https://github.com/yujiachen-y/codebase-recon-skill) ⭐ 34 | 🐛 0 | 📅 2026-04-26 - Analyze git history to understand a codebase before reading any code — auto-scales by repo size and cross-references hotspots with bug magnets to surface high-risk files, bus factor, and team momentum.
...
* [AgentPack](https://github.com/vishal2612200/agentpack) ⭐ 24 | 🐛 15 | 🌐 Python | 📅 2026-08-21 - Ranks repo context for Codex with likely files, skill recommendations, agent rules, commands, warnings, and compact task-focused packs before editing.
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 23 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-16 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
* [Frappe Agent](https://github.com/Dkm0315/frappe-agent) ⭐ 21 | 🐛 2 | 📅 2026-08-16 - Frappe and ERPNext coding, customization, bench, and review intelligence for Codex.
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [trigger-tree](https://github.com/Hedde/trigger_tree) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Local documentation telemetry for Claude Code and Codex: see which docs your agent actually reads, gate discoverability in CI, and measure instruction adherence.
* [Clean Room](https://github.com/whit3rabbit/clean-room-skill) ⭐ 9 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-19 - Spec-first clean-room workflow for authorized source analysis, behavioral specs, role separation, and verification without replacement code.
...
* [debt-ops](https://github.com/bcanfield/agentic-tech-debt) ⭐ 8 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - Catches AI-introduced tech debt at write-time: hooks log every deferral to a registry in your repo and a review skill ranks paydown by file churn.
* [Praxis](https://github.com/ouonet/praxis) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - Intent-driven workflow skills for coding agents: describe what done looks like, not the steps. Triage-first design keeps token costs low across design, TDD, debug, review, and release.
...
* [Tartiner Labs](https://github.com/tartinerlabs/skills) ⭐ 7 | 🐛 8 | 🌐 Go | 📅 2026-08-20 - Agent skills for git workflows, GitHub automation, security audits, code refactoring, and project tooling.
* [Universal Design Principles](https://github.com/HDeibler/universal-design-principles) ⭐ 7 | 🐛 1 | 🌐 Markdown | 📅 2026-05-03 - Cross-agent UX and product-design marketplace with a root Codex collection plugin, five focused plugin bundles, and 137 Agent Skills for design review, accessibility, layout, interaction, cognition, and product polish.
...
* [Maestro](https://github.com/mbanderas/maestro) ⭐ 4 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-20 - Opt-in local multi-CLI fusion engine and orchestration doctrine that fans a prompt across model CLIs, then judges and synthesizes one grounded answer.
* [Simple Man](https://github.com/Maksim-Burtsev/simple-man) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - High-compression communication mode for Codex agents that removes filler while preserving search, validation, and implementation effort.
...
* [Codex How To](https://github.com/Phelan164/codex-howto) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - Engineering-first Codex curriculum and plugin with 9 skills, measured token-efficiency experiments, bounded orchestration, testing, review, and living knowledge maintenance.
* [HOL Guard Plugin](https://github.com/hashgraph-online/hol-guard-plugin) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-21 - AI antivirus workflow for Codex, Claude Code, Cursor, Gemini, OpenCode, MCP servers, skills, and plugin release checks with local approvals and receipts.
...
* [Codex Process Jobs](https://github.com/joelfarthing/codex-process-jobs) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-18 - Run long local builds, tests, benchmarks, and inference jobs as durable detached processes with tracked status, bounded results, and completion delivery across Codex surfaces.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [Codex Usage and Resets](https://github.com/joelfarthing/codex-usage-and-resets) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-18 - Turns Codex usage into planning facts with linear pace, projected exhaustion, banked-reset expirations, and conservative unexpected-reset detection.
* [dev-harness-kit](https://github.com/sh-ai-x/dev-harness-kit) ⭐ 1 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Enforced development workflow skills for Codex and Claude Code covering planning, TDD, debugging, review, security, CI, and release.
* [GCF Proxy](https://github.com/blackwell-systems/gcf-codex-plugin) ⭐ 1 | 🐛 2 | 📅 2026-08-15 - Save 71% on MCP tool call tokens by wrapping any server with GCF encoding, with session stats hook and setup skill.
...
* [Spellbook Skills](https://github.com/yyykf/spellbook-skills) ⭐ 1 | 🐛 3 | 🌐 Python | 📅 2026-08-15 - Practical Claude Code and Codex skills for worktrees, PR/MR automation, review cleanup, YApi lookup, and Java DDD guidance.
...
* [Unforgit](https://github.com/MiguelMedeiros/unforgit-codex-plugin) ⭐ 1 | 🐛 0 | 📅 2026-08-19 - Git-backed repository memory for Codex and other coding agents via MCP, with durable local knowledge for decisions, conventions, gotchas, and playbooks.
...
* [Agent Deck](https://github.com/not-so-fat/agent-deck) ⭐ 0 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-16 - One MCP for context management: bind self-improving playbooks, MCP tools, and API keys to the session.
...
* [Embedded Workbench](https://github.com/AmethystLuna/embedded-workbench) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - Embedded C/C++ firmware development toolbox — 7 skills (FreeRTOS, Keil MDK, ARMCLANG, HardFault triage, state machines, LVGL) plus workflow gates and 4 agents for Claude Code, Codex, Cursor, Kimi, OpenCode, and ZCode.
...
* [ego-browser](https://github.com/citrolabs/ego-lite) ⭐ 12,415 | 🐛 123 | 🌐 JavaScript | 📅 2026-08-21 - Browser automation for AI agents through ego lite, a Chromium browser where agents navigate pages, fill forms, capture screenshots, and extract data in isolated task spaces that reuse the user's existing logins.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 993 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 763 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 652 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 578 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 209 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
...
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 185 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 175 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
* [Langfuse Observability](https://github.com/avivsinai/langfuse-mcp) ⭐ 104 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - Query traces, debug exceptions, analyze sessions, and manage prompts via MCP tools.
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 101 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 82 | 🐛 0 | 🌐 Go | 📅 2026-08-19 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 81 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-21 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 48 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Cargo Skills](https://github.com/getcargohq/cargo-skills) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-20 - GTM engineering for coding agents — 17 skills over the Cargo CLI for lead sourcing, contact enrichment and email verification, lead scoring, CRM sync, buying-signal monitoring, and workspace-as-code.
* [Thermal-Fluid Research Workflow](https://github.com/hanhuark/mechanical-engineering-research-skill) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - Thermal-fluid mechanical engineering research workflow for literature review, technical writing, data analysis, presentations, proposals, coding, and AI/ML tools.
...
* [Unified AI System](https://github.com/happy520ai/unified-ai-system) ⭐ 5 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-19 - Self-hosted AI gateway for Codex with provider-free prompt enhancement, nine governed MCP tools, and a credential-free Docker path.
...
* [AxonFlow](https://github.com/getaxonflow/axonflow-codex-plugin) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-08-20 - Runtime governance for Codex with policy enforcement on terminal commands, advisory checks for non-terminal tools via skills, PII/secret detection, and compliance-grade audit trails. Self-hosted via Docker.
...
* [OrgX](https://github.com/useorgx/orgx-codex-plugin) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - MCP access and initiative-aware skills for organizational workflows.
...
See the [official xAI plugin marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 160 | 🐛 147 | 🌐 Python | 📅 2026-08-20
and [Grok plugin guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/09-plugins.md) ⭐ 25,831 | 🐛 0 | 🌐 Rust | 📅 2026-08-19
before submitting.
...
plugins here in alphabetical order. See the [official Kimi plugin documentation](https://github.com/MoonshotAI/kimi-code/blob/main/docs/en/customization/plugins.md) ⭐ 6,986 | 🐛 1,166 | 🌐 TypeScript | 📅 2026-08-21
before submitting.
...
plugin tutorial](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/cordis-tutorial/01-first-plugin.md) ⭐ 179,127 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 457 | 🐛 32 | 🌐 Python | 📅 2026-08-21 as your quality gate before publishing, review, or distribution.
...
* [Awesome DeepSeek Harness Plugins](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐ 11,011 | 🐛 262 | 🌐 Python | 📅 2026-08-21 - Community-maintained DSH plugin list and discovery reference.
* [Kimi Code](https://github.com/MoonshotAI/kimi-code) ⭐ 6,986 | 🐛 1,166 | 🌐 TypeScript | 📅 2026-08-21 - Official Kimi Code runtime and plugin documentation.
* [awesome-codex-plugins](https://github.com/hashgraph-online/awesome-codex-plugins) ⭐ 830 | 🐛 32 | 🌐 Python | 📅 2026-08-21 - Codex-focused catalog that inspired this cross-platform list.
* [xAI Grok Plugin Marketplace](https://github.com/xai-org/plugin-marketplace) ⭐ 160 | 🐛 147 | 🌐 Python | 📅 2026-08-20 - Official Grok Build plugin marketplace and catalog format.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 457 | 🐛 32 | 🌐 Python | 📅 2026-08-21 to produce a trust score and security analysis.
